            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (body == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m1227constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    CancellableContinuation cancellableContinuation2 = CancellableContinuation.this;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m1227constructorimpl(body));
                    return;
                }
                CancellableContinuation cancellableContinuation3 = CancellableContinuation.this;
                HttpException httpException = new HttpException(response);
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m1227constructorimpl(ResultKt.createFailure(httpException)));
            }
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    T body = response.body();
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m1227constructorimpl(body));
                    return;
                }
                CancellableContinuation cancellableContinuation2 = CancellableContinuation.this;
                HttpException httpException = new HttpException(response);
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m1227constructorimpl(ResultKt.createFailure(httpException)));
            }
