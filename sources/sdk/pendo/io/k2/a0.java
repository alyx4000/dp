...
public final class a0 implements sdk.pendo.io.g2.b<Integer> {
    ...
    public static final a0 f1252a = new a0();

    /* renamed from: b, reason: from kotlin metadata */
    private static final sdk.pendo.io.i2.f descriptor = new w0("kotlin.Int", e.f.f1190a);
    ...
    public Integer deserialize(sdk.pendo.io.j2.d decoder) {
