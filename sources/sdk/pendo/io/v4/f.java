...
class f implements Cloneable {
    ...
    public f c() {
        ...
        long[] d = d(Math.max(1, f()));
        d[0] = 1 ^ d[0];
        return new f(d);
    }

    public Object clone() {
        return new f(sdk.pendo.io.d5.a.a(this.f));
    }
    ...
    public String toString() {
        ...
        int i = f - 1;
        StringBuffer stringBuffer = new StringBuffer(Long.toBinaryString(this.f[i]));
        while (true) {
            i--;
            if (i < 0) {
                return stringBuffer.toString();
            }
            String binaryString = Long.toBinaryString(this.f[i]);
    ...
    private static void c(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        int i5 = i + (i4 >>> 6);
        int i6 = i4 & 63;
        if (i6 == 0) {
            a(jArr, i5, jArr2, i2, i3);
        } else {
            jArr[i5] = a(jArr, i5 + 1, jArr2, i2, i3, 64 - i6) ^ jArr[i5];
        }
    }

    private static f d(long[] jArr, int i, int i2, int i3, int[] iArr) {
        return new f(jArr, i, c(jArr, i, i2, i3, iArr));
    }
    ...
    private void a(f fVar, int i, int i2) {
        ...
        int i5 = i2 & 63;
        if (i5 == 0) {
            a(this.f, i4, fVar.f, 0, i3);
            return;
        }
        long b = b(this.f, i4, fVar.f, 0, i3, i5);
        if (b != 0) {
            long[] jArr = this.f;
            int i6 = i3 + i4;
            jArr[i6] = b ^ jArr[i6];
    ...
    private static long d(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        int i5 = 64 - i4;
        long j = 0;
        for (int i6 = 0; i6 < i3; i6++) {
            long j2 = jArr[i + i6];
    ...
    public f b(int i, int[] iArr) {
        ...
        return new f(jArr, 0, c(jArr, 0, i2, i, iArr));
    }

    public void c(int i, int[] iArr) {
        long[] jArr = this.f;
        int c = c(jArr, 0, jArr.length, i, iArr);
        if (c < jArr.length) {
            long[] jArr2 = new long[c];
            this.f = jArr2;
            System.arraycopy(jArr, 0, jArr2, 0, c);
        }
    }
    ...
    private static int c(long[] jArr, int i, int i2, int i3, int[] iArr) {
        int i4 = (i3 + 63) >>> 6;
        if (i2 < i4) {
            return i2;
        }
        ...
        if (min > max) {
            b(jArr, i, i7, max, i3, iArr);
        } else {
            max = min;
        }
        if (max > i3) {
            b(jArr, i, max, i3, iArr);
        }
        return i4;
    }

    public f b(f fVar, int i, int[] iArr) {
        int i2;
        int i3;
        f fVar2;
        f fVar3;
        ...
        iArr2[1] = i8;
        System.arraycopy(fVar3.f, 0, jArr3, i8, i6);
        int i10 = 2;
        int i11 = i8;
        for (int i12 = 16; i10 < i12; i12 = 16) {
            ...
            if ((i10 & 1) == 0) {
                jArr = jArr3;
                i4 = i9;
                d(jArr3, i11 >>> 1, jArr3, i11, i8, 1);
            } else {
                jArr = jArr3;
                i4 = i9;
                a(jArr, i8, jArr, i11 - i8, jArr3, i11, i8);
            }
            i10++;
            i9 = i4;
            jArr3 = jArr;
        ...
        for (int i15 = 0; i15 < i5; i15++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                b(jArr7, i16, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) j3) & 15], i8);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            b(jArr7, i14 - i7, jArr7, i14, i7, 8);
        }
    }

    public f d(int i, int[] iArr) {
        int f = f();
        if (f == 0) {
            return this;
        }
    ...
    private static int a(long j) {
        ...
        if (i4 == 0) {
            int i5 = i3 >>> 8;
            i = i5 == 0 ? v0[i3] : v0[i5] + 8;
        } else {
            int i6 = i4 >>> 8;
            i = i6 == 0 ? v0[i4] + 16 : v0[i6] + BuiltinOptions.BatchToSpaceNDOptions;
        }
        return i2 + i;
    }
    ...
    private static boolean b(long[] jArr, int i, int i2) {
    ...
    public f a(int i, int[] iArr) {
        ...
        while (true) {
            ...
            int i9 = 1 - i2;
            fVarArr[i2].a(fVarArr[i9], iArr2[i9], i6);
            int a2 = fVarArr[i2].a(i5);
            if (a2 == 0) {
                return fVarArr2[i9];
            }
            int i10 = iArr3[i9];
            fVarArr2[i2].a(fVarArr2[i9], i10, i6);
            int i11 = i10 + i6;
            if (i11 > i4) {
                i4 = i11;
            } else if (i11 == i4) {
    ...
    public f a(f fVar, int i, int[] iArr) {
        int i2;
        int i3;
        f fVar2;
        f fVar3;
        ...
        if (i6 == 1) {
            ...
            a(j, fVar3.f, i7, jArr2, 0);
            return d(jArr2, 0, i8, i, iArr);
        }
        int i9 = ((i3 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        int i10 = i9 << 4;
        ...
        iArr2[1] = i9;
        System.arraycopy(fVar3.f, 0, jArr3, i9, i7);
        int i11 = 2;
        int i12 = i9;
        for (int i13 = 16; i11 < i13; i13 = 16) {
            ...
            if ((i11 & 1) == 0) {
                jArr = jArr3;
                i5 = i10;
                d(jArr3, i12 >>> 1, jArr3, i12, i9, 1);
            } else {
                jArr = jArr3;
                i5 = i10;
                a(jArr, i9, jArr3, i12 - i9, jArr, i12, i9);
            }
            i11++;
            i10 = i5;
            jArr3 = jArr;
        ...
        while (i16 < i6) {
            ...
            while (true) {
                ...
                long j3 = j2 >>> 4;
                i4 = i16;
                b(jArr7, i17, jArr4, iArr2[i18], jArr5, iArr2[((int) j3) & 15], i9);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i15 -= i8;
            if (i15 == 0) {
                return d(jArr7, 0, i8, i, iArr);
            }
            b(jArr7, i15 - i8, jArr7, i15, i8, 8);
        }
    }

    public f a(int i, int i2, int[] iArr) {
        int f = f();
        if (f == 0) {
            return this;
        }
        ...
        System.arraycopy(this.f, 0, jArr, 0, f);
        while (true) {
            i--;
            if (i < 0) {
                return new f(jArr, 0, f);
            }
            a(jArr, f, i2, iArr);
            f = c(jArr, 0, i3, i2, iArr);
        }
    }
    ...
    private static void a(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            length--;
            if (length < 0) {
                c(jArr, i, jArr, i + i3, i2 - i3, i5);
                return;
            }
            c(jArr, i, jArr, i + i3, i2 - i3, i5 + iArr[length]);
        }
    }
    ...
    private static void a(long[] jArr, int i, int i2, int[] iArr) {
        int i3 = i << 1;
        while (true) {
            i--;
            if (i < 0) {
