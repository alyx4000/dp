...
public class SentryOptions {
    ...
    private SentryOptions(boolean z) {
        ...
        this.shutdownTimeoutMillis = Scanner.CAMERA_SETUP_DELAY_MS;
        ...
        this.sessionTrackingIntervalMillis = ConstantsKt.PREVIEW_UPLOAD_DELAY;
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersion = new SdkVersion(BuildConfig.SENTRY_JAVA_SDK_NAME, "7.5.0");
        sdkVersion.setVersion("7.5.0");
        return sdkVersion;
    }

    private void addPackageInfo() {
        SentryIntegrationPackageStorage.getInstance().addPackage("maven:io.sentry:sentry", "7.5.0");
    }
