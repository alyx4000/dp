...
public final class SentryTracer implements ITransaction {
    ...
    public void finish(SpanStatus spanStatus, SentryDate sentryDate, boolean z, Hint hint) {
        ...
        if (!this.transactionOptions.isWaitForChildren() || hasAllChildrenFinished()) {
            ...
            List<PerformanceCollectionData> m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector = transactionPerformanceCollector != null ? transactionPerformanceCollector.m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector(this) : null;
            ProfilingTraceData onTransactionFinish = (Boolean.TRUE.equals(isSampled()) && Boolean.TRUE.equals(isProfileSampled())) ? this.hub.getOptions().getTransactionProfiler().onTransactionFinish(this, m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector, this.hub.getOptions()) : null;
            if (m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector != null) {
                m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector.clear();
            }
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda0
                ...
                public final void run(IScope iScope) {
                    SentryTracer.this.m1159lambda$finish$1$iosentrySentryTracer(iScope);
                }
            });
    ...
    /* synthetic */ void m1159lambda$finish$1$iosentrySentryTracer(final IScope iScope) {
        iScope.withTransaction(new Scope.IWithTransaction() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda2
            ...
            public final void accept(ITransaction iTransaction) {
                SentryTracer.this.m1158lambda$finish$0$iosentrySentryTracer(iScope, iTransaction);
            }
        });
    }

    /* renamed from: lambda$finish$0$io-sentry-SentryTracer, reason: not valid java name */
    /* synthetic */ void m1158lambda$finish$0$iosentrySentryTracer(IScope iScope, ITransaction iTransaction) {
        ...
        if (this.children.size() < this.hub.getOptions().getMaxSpans()) {
            ...
            Span span = new Span(this.root.getTraceId(), spanId, this, str, this.hub, sentryDate, spanOptions, new SpanFinishedCallback() { // from class: io.sentry.SentryTracer$$ExternalSyntheticLambda1
                ...
                public final void execute(Span span2) {
                    SentryTracer.this.m1157lambda$createChild$2$iosentrySentryTracer(span2);
                }
            });
    ...
    /* synthetic */ void m1157lambda$createChild$2$iosentrySentryTracer(Span span) {
        TransactionPerformanceCollector transactionPerformanceCollector = this.transactionPerformanceCollector;
        if (transactionPerformanceCollector != null) {
