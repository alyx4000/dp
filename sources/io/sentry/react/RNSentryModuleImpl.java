...
public class RNSentryModuleImpl {
    ...
    public /* synthetic */ void lambda$initNativeSdk$2(ReadableMap readableMap, final SentryAndroidOptions sentryAndroidOptions) {
        ...
        if (sdkVersion == null) {
            sdkVersion = new SdkVersion(ANDROID_SDK_NAME, "7.5.0");
        } else {
        ...
        if (readableMap.hasKey(external.sdk.pendo.io.daimajia.BuildConfig.BUILD_TYPE) && readableMap.getBoolean(external.sdk.pendo.io.daimajia.BuildConfig.BUILD_TYPE)) {
        ...
        if (readableMap.hasKey("level")) {
            ...
            switch (string.hashCode()) {
                case 3237038:
                    ...
                    break;
                case 95458899:
                    if (string.equals(external.sdk.pendo.io.daimajia.BuildConfig.BUILD_TYPE)) {
                        c = 2;
                        break;
                    }
                    c = 65535;
    ...
    private void setEventOriginTag(SentryEvent sentryEvent) {
        SdkVersion sdk2 = sentryEvent.getSdk();
        if (sdk2 != null) {
    ...
    private void setEventEnvironmentTag(SentryEvent sentryEvent, String str) {
        sentryEvent.setTag("event.origin", AndroidContextProvider.OS_NAME);
        sentryEvent.setTag("event.environment", str);
    }

    private void addPackages(SentryEvent sentryEvent, SdkVersion sdkVersion) {
        SdkVersion sdk2 = sentryEvent.getSdk();
        if (sdk2 == null || !sdk2.getName().equals("sentry.javascript.react-native") || sdkVersion == null) {
            return;
        }
        ...
        if (integrations != null) {
            ...
            while (it.hasNext()) {
                sdk2.addIntegration(it.next());
            }
        }
        sentryEvent.setSdk(sdk2);
    }
