...
public final class SentryClient implements ISentryClient, IMetricsClient {
            ...
            if (iScope != null) {
                return iScope.withSession(new Scope.IWithSession() { // from class: io.sentry.SentryClient$$ExternalSyntheticLambda1
                    ...
                    public final void accept(Session session) {
                        SentryClient.this.m1156lambda$updateSessionData$1$iosentrySentryClient(sentryEvent, hint, session);
                    }
                });
            }
    ...
    /* synthetic */ void m1156lambda$updateSessionData$1$iosentrySentryClient(SentryEvent sentryEvent, Hint hint, Session session) {
        if (session == null) {
