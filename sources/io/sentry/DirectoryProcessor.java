...
abstract class DirectoryProcessor {
        ...
        try {
            ...
            File[] listFiles2 = file.listFiles(new FilenameFilter() { // from class: io.sentry.DirectoryProcessor$$ExternalSyntheticLambda0
                ...
                public final boolean accept(File file2, String str) {
                    return DirectoryProcessor.this.m1142lambda$processDirectory$0$iosentryDirectoryProcessor(file2, str);
                }
            });
    ...
    /* synthetic */ boolean m1142lambda$processDirectory$0$iosentryDirectoryProcessor(File file, String str) {
