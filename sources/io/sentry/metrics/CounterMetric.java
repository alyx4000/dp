...
public final class CounterMetric extends Metric {
    ...
    public CounterMetric(String str, double d, MeasurementUnit measurementUnit, Map<String, String> map, Long l) {
        super(MetricType.Counter, str, measurementUnit, map, l);
        this.value = d;
    }
