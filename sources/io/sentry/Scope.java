...
public final class Scope implements IScope {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        synchronized (this.sessionLock) {
            ...
            m1160clone = this.session != null ? this.session.m1160clone() : null;
        }
        return m1160clone;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m1160clone(), session != null ? session.m1160clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session m1160clone = this.session.m1160clone();
                this.session = null;
                session = m1160clone;
            }
        }
