...
final class HostnameCache {
    ...
    private void updateCache() {
        try {
            this.executorService.submit(new Callable() { // from class: io.sentry.HostnameCache$$ExternalSyntheticLambda1
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return HostnameCache.this.m1146lambda$updateCache$1$iosentryHostnameCache();
                }
    ...
    /* synthetic */ Void m1146lambda$updateCache$1$iosentryHostnameCache() throws Exception {
        try {
