        ...
        public SentrySpan deserialize(JsonObjectReader jsonObjectReader, ILogger iLogger) throws Exception {
            ...
            while (true) {
                ...
                if (jsonObjectReader.peek() != JsonToken.NAME) {
                    ...
                    SentrySpan sentrySpan = new SentrySpan(d, d2, sentryId, spanId, spanId3, str, str5, spanStatus2, str4, hashMap, hashMap2, map3);
                ...
                switch (nextName) {
                    ...
                    case "status":
                        ...
                        break;
                    case "measurements":
                        map2 = jsonObjectReader.nextMapOrNull(iLogger, new MeasurementValue.Deserializer());
                        str3 = str4;
                        spanStatus = spanStatus2;
                        str2 = str5;
                        spanId2 = spanId3;
                    ...
                    case "op":
                        ...
                        break;
                    case "data":
                        map3 = (Map) jsonObjectReader.nextObjectOrNull();
                        str3 = str4;
                        spanStatus = spanStatus2;
                        str2 = str5;
                        spanId2 = spanId3;
