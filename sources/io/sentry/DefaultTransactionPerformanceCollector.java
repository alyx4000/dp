...
public final class DefaultTransactionPerformanceCollector implements TransactionPerformanceCollector {
            ...
            try {
                this.options.getExecutorService().schedule(new Runnable() { // from class: io.sentry.DefaultTransactionPerformanceCollector$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DefaultTransactionPerformanceCollector.this.m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector(iTransaction);
                    }
                }, 30000L);
    ...
    public List<PerformanceCollectionData> m1141lambda$start$0$iosentryDefaultTransactionPerformanceCollector(ITransaction iTransaction) {
