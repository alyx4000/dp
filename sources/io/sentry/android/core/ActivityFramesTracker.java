...
public final class ActivityFramesTracker {
        ...
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ActivityFramesTracker.this.m1163xd056273f(activity);
                }
    ...
    /* synthetic */ void m1163xd056273f(Activity activity) {
    ...
    public synchronized void setMetrics(final Activity activity, SentryId sentryId) {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m1165lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(activity);
                }
            }, null);
    ...
    /* synthetic */ void m1165lambda$setMetrics$1$iosentryandroidcoreActivityFramesTracker(Activity activity) {
    ...
    public synchronized void stop() {
        if (isFrameMetricsAggregatorAvailable()) {
            runSafelyOnUiThread(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ActivityFramesTracker.this.m1166lambda$stop$2$iosentryandroidcoreActivityFramesTracker();
                }
    ...
    /* synthetic */ void m1166lambda$stop$2$iosentryandroidcoreActivityFramesTracker() {
        ...
        try {
            if (AndroidMainThreadChecker.getInstance().isMainThread()) {
                ...
                this.handler.post(new Runnable() { // from class: io.sentry.android.core.ActivityFramesTracker$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActivityFramesTracker.this.m1164x49051cca(runnable, str);
                    }
                });
            }
    ...
    /* synthetic */ void m1164x49051cca(Runnable runnable, String str) {
        try {
            runnable.run();
        } catch (Throwable unused) {
            if (str != null) {
