...
final class LifecycleWatcher implements DefaultLifecycleObserver {
        ...
        if (this.enableSessionTracking) {
            ...
            this.hub.configureScope(new ScopeCallback() { // from class: io.sentry.android.core.LifecycleWatcher$$ExternalSyntheticLambda0
                ...
                public final void run(IScope iScope) {
                    LifecycleWatcher.this.m1181lambda$startSession$0$iosentryandroidcoreLifecycleWatcher(iScope);
                }
            });
    ...
    /* synthetic */ void m1181lambda$startSession$0$iosentryandroidcoreLifecycleWatcher(IScope iScope) {
        Session session;
