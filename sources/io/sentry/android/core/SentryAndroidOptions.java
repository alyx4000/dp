...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    private final long startupCrashDurationThresholdMillis = Scanner.CAMERA_SETUP_DELAY_MS;
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion updateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "7.5.0");
        updateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "7.5.0");
