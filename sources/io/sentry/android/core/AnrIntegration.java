...
public final class AnrIntegration implements Integration, Closeable {
            ...
            try {
                sentryAndroidOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.AnrIntegration$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        AnrIntegration.this.m1176lambda$register$0$iosentryandroidcoreAnrIntegration(iHub, sentryAndroidOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* synthetic */ void m1176lambda$register$0$iosentryandroidcoreAnrIntegration(IHub iHub, SentryAndroidOptions sentryAndroidOptions) {
            ...
            if (anrWatchDog == null) {
                ...
                ANRWatchDog aNRWatchDog = new ANRWatchDog(sentryAndroidOptions.getAnrTimeoutIntervalMillis(), sentryAndroidOptions.isAnrReportInDebug(), new ANRWatchDog.ANRListener() { // from class: io.sentry.android.core.AnrIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void onAppNotResponding(ApplicationNotResponding applicationNotResponding) {
                        AnrIntegration.this.m1177lambda$startAnrWatchdog$1$iosentryandroidcoreAnrIntegration(iHub, sentryAndroidOptions, applicationNotResponding);
                    }
    ...
    public void m1177lambda$startAnrWatchdog$1$iosentryandroidcoreAnrIntegration(IHub iHub, SentryAndroidOptions sentryAndroidOptions, ApplicationNotResponding applicationNotResponding) {
