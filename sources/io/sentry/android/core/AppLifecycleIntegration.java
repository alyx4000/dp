...
public final class AppLifecycleIntegration implements Integration, Closeable {
        ...
        if (this.options.isEnableAutoSessionTracking() || this.options.isEnableAppLifecycleBreadcrumbs()) {
            try {
                ...
                if (AndroidMainThreadChecker.getInstance().isMainThread()) {
                    m1179lambda$register$0$iosentryandroidcoreAppLifecycleIntegration(iHub);
                    ...
                    this.handler.post(new Runnable() { // from class: io.sentry.android.core.AppLifecycleIntegration$$ExternalSyntheticLambda1
                        ...
                        public final void run() {
                            AppLifecycleIntegration.this.m1179lambda$register$0$iosentryandroidcoreAppLifecycleIntegration(iHub);
                        }
                    });
                    sentryOptions = sentryOptions;
                }
    ...
    public void m1179lambda$register$0$iosentryandroidcoreAppLifecycleIntegration(IHub iHub) {
    ...
    public void m1178lambda$close$1$iosentryandroidcoreAppLifecycleIntegration() {
    ...
    public void close() throws IOException {
        ...
        if (AndroidMainThreadChecker.getInstance().isMainThread()) {
            m1178lambda$close$1$iosentryandroidcoreAppLifecycleIntegration();
        } else {
            this.handler.post(new Runnable() { // from class: io.sentry.android.core.AppLifecycleIntegration$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    AppLifecycleIntegration.this.m1178lambda$close$1$iosentryandroidcoreAppLifecycleIntegration();
                }
            });
        }
    }
