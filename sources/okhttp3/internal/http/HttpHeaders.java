...
public final class HttpHeaders {
    ...
    */
    ...
    public static final boolean promisesBody(okhttp3.Response response) {
        ...
        return (((code >= 100 && code < 200) || code == 204 || code == 304) && Util.headersContentLength(response) == -1 && !StringsKt.equals("chunked", okhttp3.Response.header$default(response, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
