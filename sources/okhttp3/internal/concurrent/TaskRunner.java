                ...
                while (true) {
                    ...
                    try {
                        try {
                            ...
                            if (isLoggable) {
                                TaskLoggerKt.log(awaitTaskToRun, queue, Intrinsics.stringPlus("finished run in ", TaskLoggerKt.formatDuration(queue.getTaskRunner().getBackend().nanoTime() - j)));
                            }
                        } finally {
                        }
                    } catch (Throwable th) {
                        if (isLoggable) {
                            TaskLoggerKt.log(awaitTaskToRun, queue, Intrinsics.stringPlus("failed a run in ", TaskLoggerKt.formatDuration(queue.getTaskRunner().getBackend().nanoTime() - j)));
                        }
                        throw th;
                    }
                }
