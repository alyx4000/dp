...
public final class Request {
    ...
    public final CacheControl m2927deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        public Builder cacheControl(CacheControl cacheControl) {
            ...
            return cacheControl2.length() == 0 ? removeHeader(HttpRequest.HEADER_CACHE_CONTROL) : header(HttpRequest.HEADER_CACHE_CONTROL, cacheControl2);
        }
