...
public final class Address {
    ...
    public final List<Protocol> m2818deprecated_protocols() {
        return this.protocols;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m2815deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public String toString() {
        ...
        return append.append(proxy != null ? Intrinsics.stringPlus("proxy=", proxy) : Intrinsics.stringPlus("proxySelector=", this.proxySelector)).append('}').toString();
    }
}
