...
public class ResourceDrawableDecoder implements i<Uri, Drawable> {
    ...
    public c<Drawable> decode(Uri uri, int i, int i2, Options options) {
        Context findContextForPackage = findContextForPackage(uri, uri.getAuthority());
        return a.a(sdk.pendo.io.z.a.a(this.context, findContextForPackage, findResourceIdFromUri(findContextForPackage, uri)));
    }
