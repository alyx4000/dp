...
@Metadata(d1 = {"\u00004\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\bÇ\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014J\u0011\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u0003HÖ\u0001J\u0019\u0010\n\u001a\u00020\t2\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\u0002HÖ\u0001J\u001a\u0010\r\u001a\f\u0012\b\u0012\u0006\u0012\u0002\b\u00030\f0\u000bHÖ\u0001¢\u0006\u0004\b\r\u0010\u000eR\u0014\u0010\u0012\u001a\u00020\u000f8VXÖ\u0005¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0015"}, d2 = {"external/sdk/pendo/io/com/appmattus/certificatetransparency/internal/loglist/model/v2/State.ReadOnly.$serializer", "Lsdk/pendo/io/k2/x;", "Lexternal/sdk/pendo/io/com/appmattus/certificatetransparency/internal/loglist/model/v2/State$ReadOnly;", "Lsdk/pendo/io/j2/d;", "decoder", "deserialize", "Lsdk/pendo/io/j2/e;", "encoder", "value", "", "serialize", "", "Lsdk/pendo/io/g2/b;", "childSerializers", "()[Lkotlinx/serialization/KSerializer;", "Lsdk/pendo/io/i2/f;", "getDescriptor", "()Lkotlinx/serialization/descriptors/SerialDescriptor;", "descriptor", "<init>", "()V", "certificatetransparency"}, k = 1, mv = {1, 6, 0})
...
public final class State$ReadOnly$$serializer implements x<State.ReadOnly> {
    ...
    static {
        ...
        q0 q0Var = new q0("readonly", state$ReadOnly$$serializer, 2);
        q0Var.a("timestamp", false);
        q0Var.a("final_tree_head", false);
        descriptor = q0Var;
    }
    ...
    public State.ReadOnly deserialize(d decoder) {
        ...
        Object obj2 = null;
        if (a2.e()) {
            long longValue = ((Number) a2.b(descriptor2, 0, new c(), 0L)).longValue();
            obj = a2.b(descriptor2, 1, FinalTreeHead$$serializer.INSTANCE, null);
            j = longValue;
            i = 3;
        } else {
            boolean z = true;
            ...
            while (z) {
                ...
                if (e == -1) {
                    ...
                    j = ((Number) a2.b(descriptor2, 0, new c(), Long.valueOf(j))).longValue();
                    i2 |= 1;
                } else {
                    if (e != 1) {
                        throw new h(e);
                    }
                    obj2 = a2.b(descriptor2, 1, FinalTreeHead$$serializer.INSTANCE, obj2);
                    i2 |= 2;
                }
            }
            i = i2;
    ...
    public void serialize(e encoder, State.ReadOnly value) {
        ...
        State.ReadOnly.write$Self(value, (sdk.pendo.io.j2.c) null, descriptor2);
        throw null;
    }
