...
class Menubar extends JMenuBar implements ActionListener {
    ...
    Menubar(SwingGui swingGui) {
        ...
        char[] cArr2 = {'T', 'C', 'P', 'F', Matrix.MATRIX_TYPE_RANDOM_LT};
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            JMenuItem jMenuItem3 = new JMenuItem(strArr7[i5], cArr4[i5]);
            jMenuItem3.addActionListener(this);
            jMenu3.add(jMenuItem3);
        }
        int i6 = 0;
        while (i6 < 5) {
            JMenuItem jMenuItem4 = new JMenuItem(strArr8[i6], cArr3[i6]);
            jMenuItem4.addActionListener(this);
            int i7 = iArr3[i6];
            if (i7 != 0) {
                jMenuItem4.setAccelerator(KeyStroke.getKeyStroke(i7, 0));
            }
            (i6 != 0 ? this.interruptOnlyItems : this.runOnlyItems).add(jMenuItem4);
            JMenu jMenu7 = jMenu5;
