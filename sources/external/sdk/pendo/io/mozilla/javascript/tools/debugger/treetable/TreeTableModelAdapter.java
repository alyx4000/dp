...
public class TreeTableModelAdapter extends AbstractTableModel {
    ...
    public TreeTableModelAdapter(TreeTableModel treeTableModel, JTree jTree) {
        ...
        jTree.addTreeExpansionListener(new TreeExpansionListener() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.debugger.treetable.TreeTableModelAdapter.1
        ...
        treeTableModel.addTreeModelListener(new TreeModelListener() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.debugger.treetable.TreeTableModelAdapter.2
    ...
    protected void delayedFireTableDataChanged() {
        SwingUtilities.invokeLater(new Runnable() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.debugger.treetable.TreeTableModelAdapter.3
