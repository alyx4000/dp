...
import external.sdk.pendo.io.mozilla.javascript.tools.shell.ConsoleTextArea;
...
class JSInternalConsole extends JInternalFrame implements ActionListener {
    ...
    public JSInternalConsole(String str) {
        ...
        pack();
        addInternalFrameListener(new InternalFrameAdapter() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.debugger.JSInternalConsole.1
