...
public class JavaPolicySecurity extends SecurityProxy {
    ...
    private static class ContextPermissions extends PermissionCollection {
        ...
        public Enumeration<Permission> elements() {
            return new Enumeration<Permission>() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.shell.JavaPolicySecurity.ContextPermissions.1
    ...
    @Override // external.sdk.pendo.io.mozilla.javascript.tools.shell.SecurityProxy
    protected void callProcessFileSecure(final Context context, final Scriptable scriptable, final String str) {
        AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.shell.JavaPolicySecurity.1
    ...
    public Object callWithDomain(Object obj, final Context context, final Callable callable, final Scriptable scriptable, final Scriptable scriptable2, final Object[] objArr) {
        return AccessController.doPrivileged(new PrivilegedAction<Object>() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.shell.JavaPolicySecurity.3
            @Override // java.security.PrivilegedAction
            public Object run() {
    ...
    public GeneratedClassLoader createClassLoader(final ClassLoader classLoader, Object obj) {
        ...
        return (GeneratedClassLoader) AccessController.doPrivileged(new PrivilegedAction<Loader>() { // from class: external.sdk.pendo.io.mozilla.javascript.tools.shell.JavaPolicySecurity.2
