...
class Block {
    ...
    private static boolean findDefPoints(OptFunctionNode optFunctionNode, Node node, int[] iArr) {
        ...
        if (type == 56 || type == 157) {
            ...
            assignType = assignType(iArr, varIndex, findExpressionType);
        } else {
            ...
            assignType = assignType(iArr, varIndex2, 1);
        }
        return z | assignType;
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Removed duplicated region for block: B:27:0x0045 A[FALL_THROUGH, RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static int findExpressionType(external.sdk.pendo.io.mozilla.javascript.optimizer.OptFunctionNode r3, external.sdk.pendo.io.mozilla.javascript.Node r4, int[] r5) {
        /*
            int r0 = r4.getType()
            r1 = 35
            if (r0 == r1) goto L76
        ...
        L31:
            ...
            return r3
        L33:
            external.sdk.pendo.io.mozilla.javascript.Node r4 = r4.getFirstChild()
            int r0 = findExpressionType(r3, r4, r5)
            external.sdk.pendo.io.mozilla.javascript.Node r4 = r4.getNext()
        ...
        L5f:
            external.sdk.pendo.io.mozilla.javascript.Node r4 = r4.getFirstChild()
            external.sdk.pendo.io.mozilla.javascript.Node r4 = r4.getNext()
            external.sdk.pendo.io.mozilla.javascript.Node r0 = r4.getNext()
        ...
        L75:
            return r2
        L76:
            external.sdk.pendo.io.mozilla.javascript.Node r4 = r4.getLastChild()
            int r3 = findExpressionType(r3, r4, r5)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: external.sdk.pendo.io.mozilla.javascript.optimizer.Block.findExpressionType(external.sdk.pendo.io.mozilla.javascript.optimizer.OptFunctionNode, external.sdk.pendo.io.mozilla.javascript.Node, int[]):int");
    }
