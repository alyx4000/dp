...
public class PermissionsService implements InternalModule, Permissions, LifecycleEventListener {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void askForPermissions$lambda$10(PermissionsService this$0, PermissionsResponseListener responseListener, Map it) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(responseListener, "$responseListener");
        int i = this$0.hasWriteSettingsPermission() ? 0 : -1;
        Intrinsics.checkNotNullExpressionValue(it, "it");
        it.put("android.permission.WRITE_SETTINGS", this$0.getPermissionResponseFromNativeResponse("android.permission.WRITE_SETTINGS", i));
