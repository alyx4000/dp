...
public final class SystemUIModule extends Module {
    ...
    public ModuleDefinitionData definition() {
        ...
        try {
            ...
            if (Integer.class == Promise.class) {
                asyncFunctionComponent = new AsyncFunctionWithPromiseComponent("setBackgroundColorAsync", new AnyType[0], new Function2<Object[], Promise, Unit>() { // from class: expo.modules.systemui.SystemUIModule$definition$lambda$3$$inlined$AsyncFunction$1
                    {
                        super(2);
                    }
                ...
                asyncFunctionComponent = new AsyncFunctionComponent("setBackgroundColorAsync", new AnyType[]{new AnyType(new LazyKType(Reflection.getOrCreateKotlinClass(Integer.class), true, new Function0<KType>() { // from class: expo.modules.systemui.SystemUIModule$definition$lambda$3$$inlined$AsyncFunction$2
                    @Override // kotlin.jvm.functions.Function0
                    public final KType invoke() {
                        return Reflection.nullableTypeOf(Integer.class);
                    }
                }))}, new Function1<Object[], Object>() { // from class: expo.modules.systemui.SystemUIModule$definition$lambda$3$$inlined$AsyncFunction$3
                    {
                        super(1);
                    }
            ...
            moduleDefinitionBuilder2.getAsyncFunctions().put("setBackgroundColorAsync", asyncFunctionComponent);
            asyncFunctionComponent.runOnQueue(Queues.MAIN);
            AsyncFunctionComponent asyncFunctionComponent2 = new AsyncFunctionComponent("getBackgroundColorAsync", new AnyType[0], new Function1<Object[], Object>() { // from class: expo.modules.systemui.SystemUIModule$definition$lambda$3$$inlined$AsyncFunctionWithoutArgs$1
                {
                    super(1);
                }
            ...
            moduleDefinitionBuilder.getAsyncFunctions().put("getBackgroundColorAsync", asyncFunctionComponent2);
    ...
    /* compiled from: SystemUIModule.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, d2 = {"Lexpo/modules/systemui/SystemUIModule$Companion;", "", "()V", "colorToHex", "", "color", "", "expo-system-ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
