...
public final class MediaLibraryModule$definition$1$13$1$action$1$invoke$$inlined$withModuleScope$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MediaLibraryModule$definition$1$13$1$action$1$invoke$$inlined$withModuleScope$1(Promise promise, Continuation continuation, MediaLibraryModule mediaLibraryModule, String str, String str2, boolean z, Promise promise2) {
        super(2, continuation);
        this.$promise = promise;
        this.this$0 = mediaLibraryModule;
        this.$albumName$inlined = str;
        this.$assetId$inlined = str2;
        this.$copyAsset$inlined = z;
        this.$promise$inlined = promise2;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MediaLibraryModule$definition$1$13$1$action$1$invoke$$inlined$withModuleScope$1(this.$promise, continuation, this.this$0, this.$albumName$inlined, this.$assetId$inlined, this.$copyAsset$inlined, this.$promise$inlined);
    }
