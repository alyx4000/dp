...
@Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0010\u0018\u00002\u00020\u0001:\u0001\tB\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, d2 = {"Lexpo/modules/medialibrary/albums/GetAlbums;", "", "context", "Landroid/content/Context;", BaseJavaModule.METHOD_TYPE_PROMISE, "Lexpo/modules/kotlin/Promise;", "(Landroid/content/Context;Lexpo/modules/kotlin/Promise;)V", "execute", "", "Album", "expo-media-library_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public class GetAlbums {
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (cursor.getType(columnIndex2) != 0) {
                        Album album = (Album) hashMap.get(id);
                        if (album == null) {
                            Intrinsics.checkNotNullExpressionValue(id, "id");
                            String string = cursor.getString(columnIndex2);
                            Intrinsics.checkNotNullExpressionValue(string, "assetCursor.getString(bucketDisplayNameIndex)");
                            album = new Album(id, string, 0, 4, null);
                            hashMap.put(id, album);
                        }
                        Intrinsics.checkNotNullExpressionValue(album, "albums[id] ?: Album(\n   …ms[id] = it\n            }");
                        album.setCount(album.getCount() + 1);
                    }
                }
                Promise promise = this.promise;
                Collection values = hashMap.values();
                Intrinsics.checkNotNullExpressionValue(values, "albums.values");
    ...
    /* compiled from: GetAlbums.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0006\u0010\f\u001a\u00020\rR\u001a\u0010\u0005\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0004\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Lexpo/modules/medialibrary/albums/GetAlbums$Album;", "", "id", "", "title", "count", "", "(Ljava/lang/String;Ljava/lang/String;I)V", "getCount", "()I", "setCount", "(I)V", "toBundle", "Landroid/os/Bundle;", "expo-media-library_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
