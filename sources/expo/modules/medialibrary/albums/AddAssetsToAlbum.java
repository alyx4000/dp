...
public final class AddAssetsToAlbum {
    ...
    private final File getAlbum() {
        Cursor query = this.context.getContentResolver().query(MediaLibraryConstantsKt.getEXTERNAL_CONTENT_URI(), new String[]{"_data"}, "bucket_id=?", new String[]{this.albumId}, null);
        try {
            Cursor cursor = query;
            if (cursor == null) {
