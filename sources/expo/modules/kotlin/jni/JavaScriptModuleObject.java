...
public final class JavaScriptModuleObject implements Destructible {
    ...
    public final native void registerClass(String name, JavaScriptModuleObject classModule, boolean takesOwner, ExpectedType[] desiredTypes, JNIFunctionBody body);
    ...
    public final JavaScriptModuleObject initUsingObjectDefinition(AppContext appContext, ObjectDefinitionData definition) {
        ...
        WritableNativeMap convertedConstants = Arguments.makeNativeMap(definition.getConstantsProvider().invoke());
