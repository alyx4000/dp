...
public final class Uint8Array implements TypedArray, GenericTypedArray<UByte>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ UByte get(int i) {
        return UByte.m1239boximpl(m1032getWa3L5BU(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, UByte uByte) {
        m1033setEK6454(i, uByte.getData());
    }

    /* renamed from: get-Wa3L5BU, reason: not valid java name */
    public byte m1032getWa3L5BU(int index) {
    ...
    public void m1033setEK6454(int index, byte value) {
        Uint8Array uint8Array = this;
        if (index >= 0 && index < uint8Array.getLength()) {
