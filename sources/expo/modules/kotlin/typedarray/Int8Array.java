...
public final class Int8Array implements TypedArray, GenericTypedArray<Byte>, RawTypedArrayHolder {
    ...
    public Byte get(int index) {
        ...
        if (index >= 0 && index < int8Array.getLength()) {
            return Byte.valueOf(readByte(index * 1));
        }
