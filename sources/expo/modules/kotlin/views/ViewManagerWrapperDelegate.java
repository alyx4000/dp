...
public final class ViewManagerWrapperDelegate {
    ...
    /* JADX WARN: Type inference failed for: r7v11, types: [expo.modules.kotlin.modules.Module] */
    public final List<String> updateProperties(View view, ReadableMap propsMap) {
        ...
        Intrinsics.checkNotNullExpressionValue(keySetIterator, "propsMap.keySetIterator()");
        while (keySetIterator.hasNextKey()) {
            ...
            if (anyViewProp != null) {
                try {
                    ...
                    Intrinsics.checkNotNullExpressionValue(dynamic, "propsMap.getDynamic(key)");
