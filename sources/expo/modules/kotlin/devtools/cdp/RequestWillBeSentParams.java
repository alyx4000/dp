...
public final /* data */ class RequestWillBeSentParams implements JsonSerializable {
    ...
    public int hashCode() {
        int hashCode = ((((((((((((this.requestId.hashCode() * 31) + this.loaderId.hashCode()) * 31) + this.documentURL.hashCode()) * 31) + this.request.hashCode()) * 31) + this.timestamp.hashCode()) * 31) + this.wallTime.hashCode()) * 31) + this.initiator.hashCode()) * 31;
        ...
        return ((((i2 + (response == null ? 0 : response.hashCode())) * 31) + this.referrerPolicy.hashCode()) * 31) + this.type.hashCode();
    }
    ...
    public /* synthetic */ RequestWillBeSentParams(String str, String str2, String str3, Request request, BigDecimal bigDecimal, BigDecimal bigDecimal2, Map map, boolean z, Response response, String str4, ResourceType resourceType, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i & 2) != 0 ? "" : str2, (i & 4) != 0 ? "mobile" : str3, request, bigDecimal, bigDecimal2, (i & 64) != 0 ? MapsKt.mapOf(TuplesKt.to("type", JavascriptRunner.SCRIPT_NAME)) : map, z, response, (i & 512) != 0 ? "no-referrer" : str4, resourceType);
    }
