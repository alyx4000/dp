        ...
        final ?? r9 = new OnActivityAvailableListener() { // from class: expo.modules.kotlin.activityresult.ActivityResultsManager$registerForActivityResult$$inlined$withActivityAvailable$1
            ...
            public void onActivityAvailable(AppCompatActivity activity) {
                ...
                try {
                    ...
                    m1227constructorimpl = Result.m1227constructorimpl(appContextActivityResultRegistry.register("AppContext_rq#" + atomicInteger.getAndIncrement(), activity, appContextActivityResultContract, appContextActivityResultFallbackCallback));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th));
                }
