...
public final class SharedObjectTypeConverter<T extends SharedObject> extends NullAwareTypeConverter<T> {
    ...
    public T convertNonOptional(Object value, AppContext context) {
        ...
        int m1014constructorimpl = SharedObjectId.m1014constructorimpl(intValue);
        if (context != null) {
            T t = (T) SharedObjectId.m1019toNativeObjectimpl(m1014constructorimpl, context);
            if (t != null) {
                return t;
            }
