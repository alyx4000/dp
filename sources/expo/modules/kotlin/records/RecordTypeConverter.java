...
public final class RecordTypeConverter<T extends Record> extends DynamicAwareTypeConverters<T> {
    ...
    static final /* data */ class PropertyDescriptor {
        ...
        public int hashCode() {
            ...
            return ((hashCode + i) * 31) + this.validators.hashCode();
        }
