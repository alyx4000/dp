...
public final class DevMenuCommandHandlersProvider {
    ...
    public DevMenuCommandHandlersProvider(DevMenuManagerInterface manager, ReactInstanceManager reactInstanceManager) {
        ...
        this.onDevMenu = new NotificationOnlyHandler() { // from class: expo.modules.devmenu.websockets.DevMenuCommandHandlersProvider$onDevMenu$1
            ...
            public void onNotification(Object params) {
                ...
                instanceManager = DevMenuCommandHandlersProvider.this.getInstanceManager();
                if (instanceManager == null || (currentReactContext = instanceManager.getCurrentReactContext()) == null || (currentActivity = currentReactContext.getCurrentActivity()) == null) {
                    return;
                }
        ...
        this.onDevCommand = new NotificationOnlyHandler() { // from class: expo.modules.devmenu.websockets.DevMenuCommandHandlersProvider$onDevCommand$1
            ...
            public void onNotification(Object params) {
                ...
                devMenuManagerInterface = DevMenuCommandHandlersProvider.this.manager;
                DevMenuDevToolsDelegate devMenuDevToolsDelegate = new DevMenuDevToolsDelegate(devMenuManagerInterface, instanceManager);
                ...
                switch (optString.hashCode()) {
                    ...
                    case -472895200:
                        if (optString.equals("toggleDevMenu")) {
                            ReactContext currentReactContext3 = instanceManager.getCurrentReactContext();
    ...
    public final ReactInstanceManager getInstanceManager() {
        return this._instanceManager.get();
    }
