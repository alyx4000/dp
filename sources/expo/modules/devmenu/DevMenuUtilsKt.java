...
public final class DevMenuUtilsKt {
    ...
    public static final JSIModulePackage getVendoredJNIPackage(String className) {
        Intrinsics.checkNotNullParameter(className, "className");
        return (JSIModulePackage) getVendoredClass(className, new Class[0], new Object[0]);
    }
    ...
    public static final <T> T getVendoredClass(String className, Class<?>[] argsType, Object[] args) {
        ...
        try {
            clazz = Class.forName("devmenu." + className);
        } catch (ClassNotFoundException unused) {
            clazz = Class.forName(className);
        }
        Intrinsics.checkNotNullExpressionValue(clazz, "clazz");
        return (T) constructFromClass(clazz, argsType, args);
    }
