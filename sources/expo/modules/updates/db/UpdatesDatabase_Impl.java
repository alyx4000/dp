...
public final class UpdatesDatabase_Impl extends UpdatesDatabase {
    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
        return configuration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(configuration.context).name(configuration.name).callback(new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(12) { // from class: expo.modules.updates.db.UpdatesDatabase_Impl.1
            ...
            public void createAllTables(SupportSQLiteDatabase _db) {
                ...
                _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '472340246d291854f67ce4b51e48fb0b')");
            }
            ...
            public void dropAllTables(SupportSQLiteDatabase _db) {
                ...
                if (UpdatesDatabase_Impl.this.mCallbacks != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) UpdatesDatabase_Impl.this.mCallbacks.get(i)).onDestructiveMigration(_db);
                    }
                }
            }
            ...
            protected void onCreate(SupportSQLiteDatabase _db) {
                if (UpdatesDatabase_Impl.this.mCallbacks != null) {
                    int size = UpdatesDatabase_Impl.this.mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) UpdatesDatabase_Impl.this.mCallbacks.get(i)).onCreate(_db);
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase _db) {
                ...
                if (UpdatesDatabase_Impl.this.mCallbacks != null) {
                    int size = UpdatesDatabase_Impl.this.mCallbacks.size();
                    for (int i = 0; i < size; i++) {
                        ((RoomDatabase.Callback) UpdatesDatabase_Impl.this.mCallbacks.get(i)).onOpen(_db);
                    }
                }
            }
            ...
            protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
                ...
                hashMap3.put(DatabaseConstants.KEY_FIELD, new TableInfo.Column(DatabaseConstants.KEY_FIELD, "TEXT", false, 0, null, 1));
                ...
                hashSet6.add(new TableInfo.Index("index_assets_key", true, Arrays.asList(DatabaseConstants.KEY_FIELD), Arrays.asList("ASC")));
                ...
                hashMap4.put(DatabaseConstants.KEY_FIELD, new TableInfo.Column(DatabaseConstants.KEY_FIELD, "TEXT", true, 0, null, 1));
