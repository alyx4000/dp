...
public final class DatabaseLauncher implements Launcher {
    ...
    public Map<AssetEntity, String> mo1072getLocalAssetFiles() {
    ...
    public boolean getIsUsingEmbeddedAssets() {
        return mo1072getLocalAssetFiles() == null;
    }
    ...
    public final UpdateEntity getLaunchableUpdate(UpdatesDatabase database, Context context) {
        ...
        for (UpdateEntity updateEntity : loadLaunchableUpdatesForScope) {
            if (updateEntity.getStatus() != UpdateStatus.EMBEDDED || bareUpdateManifest == null || Intrinsics.areEqual(bareUpdateManifest.getUpdateEntity().getId(), updateEntity.getId())) {
    ...
    private final Map<AssetEntity, String> embeddedAssetFileMap(Context context) {
        ...
        BareUpdateManifest bareUpdateManifest = EmbeddedManifest.INSTANCE.get(context, this.configuration);
        if (bareUpdateManifest == null || (emptyList = bareUpdateManifest.getAssetEntityList()) == null) {
    ...
    public final File ensureAssetExists(AssetEntity asset, final UpdatesDatabase database, Context context) {
        BareUpdateManifest bareUpdateManifest;
        ...
        if (!exists && (bareUpdateManifest = EmbeddedManifest.INSTANCE.get(context, this.configuration)) != null) {
            Iterator<AssetEntity> it = bareUpdateManifest.getAssetEntityList().iterator();
            while (true) {
                if (!it.hasNext()) {
                    assetEntity = null;
                    break;
    ...
    public final synchronized void maybeFinish(AssetEntity asset, File assetFile) {
        ...
        if (asset.getIsLaunchAsset()) {
            ...
            Map<AssetEntity, String> mo1072getLocalAssetFiles = mo1072getLocalAssetFiles();
            Intrinsics.checkNotNull(mo1072getLocalAssetFiles);
            String file2 = assetFile.toString();
            Intrinsics.checkNotNullExpressionValue(file2, "assetFile.toString()");
            mo1072getLocalAssetFiles.put(asset, file2);
        }
