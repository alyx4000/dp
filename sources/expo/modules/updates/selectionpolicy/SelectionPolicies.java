...
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\b\u0010\f\u001a\u0004\u0018\u00010\rR\u0019\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\u000e"}, d2 = {"Lexpo/modules/updates/selectionpolicy/SelectionPolicies;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "getTAG", "()Ljava/lang/String;", "matchesFilters", "", "update", "Lexpo/modules/updates/db/entity/UpdateEntity;", "manifestFilters", "Lorg/json/JSONObject;", "expo-updates_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public final boolean matchesFilters(UpdateEntity update, JSONObject manifestFilters) {
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                jSONObject.put(lowerCase, metadata.get(key));
            }
            Iterator<String> keys2 = manifestFilters.keys();
            while (keys2.hasNext()) {
                String next = keys2.next();
                if (jSONObject.has(next) && !Intrinsics.areEqual(manifestFilters.get(next), jSONObject.get(next))) {
                    return false;
                }
            }
            return true;
