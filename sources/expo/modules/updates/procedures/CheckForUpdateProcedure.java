...
public final class CheckForUpdateProcedure extends StateMachineProcedure {
    ...
    public static final void run$lambda$0(final CheckForUpdateProcedure this$0, final StateMachineProcedure.ProcedureContext procedureContext) {
        ...
        Intrinsics.checkNotNullParameter(procedureContext, "$procedureContext");
        BareUpdateManifest bareUpdateManifest = EmbeddedManifest.INSTANCE.get(this$0.context, this$0.updatesConfiguration);
        final UpdateEntity updateEntity = bareUpdateManifest != null ? bareUpdateManifest.getUpdateEntity() : null;
        ...
        this$0.fileDownloader.downloadRemoteUpdate(this$0.updatesConfiguration, extraHeadersForRemoteUpdateRequest, this$0.context, new FileDownloader.RemoteUpdateDownloadCallback() { // from class: expo.modules.updates.procedures.CheckForUpdateProcedure$run$1$1
            ...
            public void onSuccess(UpdateResponse updateResponse) {
                ...
                if (updateEntity2 == null) {
                    ...
                    function13.invoke(new IUpdatesController.CheckForUpdateResult.UpdateAvailable(updateManifest));
                    StateMachineProcedure.ProcedureContext.this.processStateEvent(new UpdatesStateEvent.CheckCompleteWithUpdate(updateManifest.getManifest().getRawJson()));
                    StateMachineProcedure.ProcedureContext.this.onComplete();
                    return;
                }
                selectionPolicy = this$0.selectionPolicy;
                UpdateEntity updateEntity6 = updateManifest.getUpdateEntity();
                ...
                if (shouldLoadNewUpdate) {
                    UpdateEntity updateEntity7 = updateManifest.getUpdateEntity();
                ...
                if (r0) {
                    ...
                    function12.invoke(new IUpdatesController.CheckForUpdateResult.UpdateAvailable(updateManifest));
                    StateMachineProcedure.ProcedureContext.this.processStateEvent(new UpdatesStateEvent.CheckCompleteWithUpdate(updateManifest.getManifest().getRawJson()));
                    StateMachineProcedure.ProcedureContext.this.onComplete();
                    return;
                }
