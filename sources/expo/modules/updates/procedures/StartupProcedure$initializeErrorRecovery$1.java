...
public final class StartupProcedure$initializeErrorRecovery$1 implements ErrorRecoveryDelegate {
    ...
    public void markFailedLaunchForLaunchedUpdate() {
        Handler handler;
        if (this.this$0.getIsEmergencyLaunch()) {
            return;
        }
