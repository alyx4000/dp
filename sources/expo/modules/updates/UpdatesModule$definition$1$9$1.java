...
final class UpdatesModule$definition$1$9$1 implements Runnable {
    final /* synthetic */ Promise $promise;
    final /* synthetic */ UpdatesModule this$0;

    UpdatesModule$definition$1$9$1(UpdatesModule updatesModule, Promise promise) {
    ...
    public final void run() {
        ...
        companion.clearLogEntries$expo_updates_release(context, new Function1<Error, Unit>() { // from class: expo.modules.updates.UpdatesModule$definition$1$9$1.1
            {
                super(1);
            }
