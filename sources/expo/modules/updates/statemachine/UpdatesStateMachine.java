...
public final class UpdatesStateMachine {
    ...
    public UpdatesStateMachine(Context androidContext, UpdatesStateChangeEventSender changeEventSender) {
        Intrinsics.checkNotNullParameter(androidContext, "androidContext");
        Intrinsics.checkNotNullParameter(changeEventSender, "changeEventSender");
        this.changeEventSender = changeEventSender;
        this.serialExecutorQueue = new StateMachineSerialExecutorQueue(new StateMachineProcedure.StateMachineProcedureContext() { // from class: expo.modules.updates.statemachine.UpdatesStateMachine$serialExecutorQueue$1
        ...
        this.logger = new UpdatesLogger(androidContext);
