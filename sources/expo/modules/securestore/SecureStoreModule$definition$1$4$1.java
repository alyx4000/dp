...
final class SecureStoreModule$definition$1$4$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    ...
    SecureStoreModule$definition$1$4$1(SecureStoreModule secureStoreModule, String str, SecureStoreOptions secureStoreOptions, Continuation<? super SecureStoreModule$definition$1$4$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            obj = this.this$0.getItemImpl(this.$key, this.$options, this);
