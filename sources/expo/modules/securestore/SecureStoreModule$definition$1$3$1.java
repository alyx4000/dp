...
@DebugMetadata(c = "expo.modules.securestore.SecureStoreModule$definition$1$3$1", f = "SecureStoreModule.kt", i = {}, l = {49}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class SecureStoreModule$definition$1$3$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    SecureStoreModule$definition$1$3$1(SecureStoreModule secureStoreModule, String str, String str2, SecureStoreOptions secureStoreOptions, Continuation<? super SecureStoreModule$definition$1$3$1> continuation) {
