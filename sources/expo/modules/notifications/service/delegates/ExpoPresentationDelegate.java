...
public class ExpoPresentationDelegate implements PresentationDelegate {
    ...
    public Collection<Notification> getAllPresentedNotifications() {
        ...
        for (StatusBarNotification it : activeNotifications) {
            ...
            Notification notification = getNotification(it);
    ...
    public void dismissNotifications(Collection<String> identifiers) {
        ...
        for (String str : identifiers) {
            ...
            if (parseNotificationIdentifier != null) {
                ...
                from.cancel(str2, ((Number) obj2).intValue());
            } else {
    ...
    protected Notification getNotification(StatusBarNotification statusBarNotification) {
        ...
        if (byteArray != null) {
            try {
                ...
                Intrinsics.checkNotNullExpressionValue(createFromParcel, "CREATOR.createFromParcel(this)");
                obtain.recycle();
        ...
        return new Notification(new NotificationRequest(INSTANCE.getInternalIdentifierKey(statusBarNotification), sticky.setBody(fromBundle(bundle)).build(), null), new Date(statusBarNotification.getPostTime()));
    }
