...
public final class LocalizationUtilsKt {
    ...
    public static final String getCountryCode(Locale locale) {
        ...
        try {
            ...
            m1227constructorimpl = Result.m1227constructorimpl(country);
        } catch (Throwable th) {
    ...
    public static final String getSystemProperty(String key) {
        ...
        try {
            ...
            m1227constructorimpl = Result.m1227constructorimpl((String) invoke);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th));
        }
        ...
        String str = (String) m1227constructorimpl;
        return str == null ? "" : str;
    }
    ...
    public static final String getCurrencyCode(Locale locale) {
        ...
        try {
            ...
            m1227constructorimpl = Result.m1227constructorimpl(currency != null ? currency.getCurrencyCode() : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th));
        }
