...
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010$\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\u0018\u00002\u00020\u0001:\u0001\u0014B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J,\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0012\u0010\u000b\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\f2\b\u0010\r\u001a\u0004\u0018\u00010\u000eJ\u0006\u0010\u000f\u001a\u00020\bJ\b\u0010\u0010\u001a\u0004\u0018\u00010\u0011J\f\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\u0013R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lexpo/modules/devlauncher/launcher/DevLauncherRecentlyOpenedAppsRegistry;", "", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "sharedPreferences", "Landroid/content/SharedPreferences;", "appWasOpened", "", "url", "", "queryParams", "", "manifest", "Lexpo/modules/manifests/core/Manifest;", "clearRegistry", "getMostRecentApp", "Lexpo/modules/devlauncher/launcher/DevLauncherAppEntry;", "getRecentlyOpenedApps", "", "TimeHelper", "expo-dev-launcher_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class DevLauncherRecentlyOpenedAppsRegistry {
    ...
    public final void appWasOpened(String url, Map<String, String> queryParams, Manifest manifest) {
        ...
        if (this.sharedPreferences.contains(url)) {
            Map previousEntry = (Map) new Gson().fromJson(this.sharedPreferences.getString(url, null), Map.class);
            Intrinsics.checkNotNullExpressionValue(previousEntry, "previousEntry");
            Map mutableMap = MapsKt.toMutableMap(previousEntry);
    ...
    public final List<DevLauncherAppEntry> getRecentlyOpenedApps() {
        ...
        for (Map.Entry<String, ?> entry : all.entrySet()) {
            ...
            DevLauncherAppEntry appEntry = (DevLauncherAppEntry) gson.fromJson((String) value, DevLauncherAppEntry.class);
            if (TimeHelper.INSTANCE.getCurrentTime() - appEntry.getTimestamp() > 259200000) {
                Intrinsics.checkNotNullExpressionValue(url, "url");
                arrayList2.add(url);
            } else {
                Intrinsics.checkNotNullExpressionValue(appEntry, "appEntry");
    ...
    /* compiled from: DevLauncherRecentlyOpenedAppsRegistry.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004¨\u0006\u0005"}, d2 = {"Lexpo/modules/devlauncher/launcher/DevLauncherRecentlyOpenedAppsRegistry$TimeHelper;", "", "()V", "getCurrentTime", "", "expo-dev-launcher_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
