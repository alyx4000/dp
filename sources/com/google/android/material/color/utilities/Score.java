...
public final class Score {
    ...
    public static List<Integer> score(Map<Integer, Integer> map) {
        ...
        for (Map.Entry entry2 : hashMap.entrySet()) {
            ...
            hashMap3.put(Integer.valueOf(intValue4), Double.valueOf((((Double) hashMap2.get(Integer.valueOf(intValue4))).doubleValue() * 100.0d * WEIGHT_PROPORTION) + ((cam16.getChroma() - TARGET_CHROMA) * (cam16.getChroma() < TARGET_CHROMA ? 0.1d : WEIGHT_CHROMA_ABOVE))));
        }
