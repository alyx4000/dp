...
final class zzhg implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzmbVar.zzc());
        objectEncoderContext2.add(zzc, zzmbVar.zze());
        objectEncoderContext2.add(zzd, zzmbVar.zza());
        objectEncoderContext2.add(zze, zzmbVar.zzb());
        objectEncoderContext2.add(zzf, zzmbVar.zzd());
        objectEncoderContext2.add(zzg, zzmbVar.zzf());
    }
}
