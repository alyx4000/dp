...
final class zzdm implements ObjectEncoderContext {
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzdl
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) {
                zzdm.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzdk zzdkVar = (zzdk) fieldDescriptor.getProperty(zzdk.class);
        if (zzdkVar != null) {
            return zzdkVar.zza();
        }
    ...
    private final zzdm zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzdm zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    final zzdm zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    final zzdm zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzdk zzj = zzj(fieldDescriptor);
    ...
    final zzdm zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
