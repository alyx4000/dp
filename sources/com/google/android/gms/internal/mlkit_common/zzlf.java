...
public enum zzlf implements zzbm {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_LANGUAGE_IDENTIFICATION_DETECT(Token.DEBUGGER),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CREATE(Token.COMMENT),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_LOAD(Token.METHOD),
    ON_DEVICE_LANGUAGE_IDENTIFICATION_CLOSE(Token.GENEXPR),
    ...
    OPTIONAL_MODULE_NLCLASSIFIER_CREATE(HttpServletResponse.SC_PRECONDITION_FAILED),
