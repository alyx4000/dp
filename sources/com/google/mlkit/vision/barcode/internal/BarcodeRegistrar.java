...
public class BarcodeRegistrar implements ComponentRegistrar {
    ...
    public final List getComponents() {
        return zzcd.zzh(Component.builder(zzf.class).add(Dependency.required((Class<?>) MlKitContext.class)).factory(new ComponentFactory() { // from class: com.google.mlkit.vision.barcode.internal.zzc
