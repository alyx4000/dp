...
public interface KSVisitor<D, R> {
    ...
    R visitDynamicReference(KSDynamicReference reference, D data);

    R visitFile(KSFile file, D data);

    R visitFunctionDeclaration(KSFunctionDeclaration function, D data);

    R visitModifierListOwner(KSModifierListOwner modifierListOwner, D data);

    R visitNode(KSNode node, D data);

    R visitParenthesizedReference(KSParenthesizedReference reference, D data);

    R visitPropertyAccessor(KSPropertyAccessor accessor, D data);
    ...
    R visitValueArgument(KSValueArgument valueArgument, D data);
