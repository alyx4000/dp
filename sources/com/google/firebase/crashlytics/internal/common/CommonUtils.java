...
public class CommonUtils {
    ...
    enum Architecture {
        ...
        static {
            ...
            matcher = hashMap;
            hashMap.put(MinElf.ISA.ARM, architecture3);
            hashMap.put("armeabi", architecture2);
            hashMap.put(MinElf.ISA.AARCH64, architecture4);
            hashMap.put(MinElf.ISA.X86, architecture);
        }
    ...
    public static String getResourcePackageName(Context context) {
        ...
        if (i > 0) {
            try {
                ...
                return AndroidContextProvider.OS_NAME.equals(resourcePackageName) ? context.getPackageName() : resourcePackageName;
