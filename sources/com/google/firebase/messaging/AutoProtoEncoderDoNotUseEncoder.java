...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor MESSAGEID_DESCRIPTOR = FieldDescriptor.builder(IterableConstants.KEY_MESSAGE_ID).withProperty(AtProtobuf.builder().tag(2).build()).build();
        ...
        private static final FieldDescriptor CAMPAIGNID_DESCRIPTOR = FieldDescriptor.builder(IterableConstants.KEY_CAMPAIGN_ID).withProperty(AtProtobuf.builder().tag(14).build()).build();
