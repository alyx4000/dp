...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(DatabaseConstants.KEY_FIELD).withProperty(AtProtobuf.builder().tag(1).build()).build();
