...
public final class SessionsSettings {
    ...
    */
    ...
    public final long m907getSessionRestartTimeoutUwyO8pc() {
        Duration mo905getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo905getSessionRestartTimeoutFghU774();
        if (mo905getSessionRestartTimeoutFghU774 != null) {
            long rawValue = mo905getSessionRestartTimeoutFghU774.getRawValue();
            if (m906isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration mo905getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo905getSessionRestartTimeoutFghU774();
        if (mo905getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = mo905getSessionRestartTimeoutFghU7742.getRawValue();
            if (m906isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m906isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m2602isPositiveimpl(sessionRestartTimeout) && Duration.m2597isFiniteimpl(sessionRestartTimeout);
    }
