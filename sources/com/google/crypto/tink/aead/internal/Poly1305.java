...
public class Poly1305 {
    ...
    private static long load32(byte[] in, int idx) {
        return (((in[idx + 3] & UByte.MAX_VALUE) << 24) | (in[idx] & UByte.MAX_VALUE) | ((in[idx + 1] & UByte.MAX_VALUE) << 8) | ((in[idx + 2] & UByte.MAX_VALUE) << 16)) & BodyPartID.bodyIdMax;
    }
    ...
    public static byte[] computeMac(final byte[] key, byte[] data) {
        ...
        while (i3 < data.length) {
            ...
            long load2610 = j8 + (load26(bArr, 12, 8) | (bArr[16] << BuiltinOptions.BatchToSpaceNDOptions));
        ...
        long j45 = (j35 | (j29 & j40) | (j41 << 26)) & BodyPartID.bodyIdMax;
        long j46 = ((j41 >> 6) | (j42 << 20)) & BodyPartID.bodyIdMax;
        long j47 = ((j42 >> 12) | (j43 << 14)) & BodyPartID.bodyIdMax;
        long j48 = ((j43 >> 18) | (j44 << 8)) & BodyPartID.bodyIdMax;
        long load32 = j45 + load32(key, 16);
        long j49 = load32 & BodyPartID.bodyIdMax;
        long load322 = j46 + load32(key, 20) + (load32 >> 32);
        long j50 = load322 & BodyPartID.bodyIdMax;
        long load323 = j47 + load32(key, 24) + (load322 >> 32);
        long j51 = load323 & BodyPartID.bodyIdMax;
        long load324 = (j48 + load32(key, 28) + (load323 >> 32)) & BodyPartID.bodyIdMax;
