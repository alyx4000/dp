...
@DebugMetadata(c = "com.extole.android.sdk.RNExtole$identifyJwt$1", f = "RNExtole.kt", i = {}, l = {168}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
final class RNExtole$identifyJwt$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    RNExtole$identifyJwt$1(RNExtole rNExtole, ReadableMap readableMap, String str, Continuation<? super RNExtole$identifyJwt$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new RNExtole$identifyJwt$1(this.this$0, this.$data, this.$jwt, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super String> continuation) {
        return ((RNExtole$identifyJwt$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (extoleInternal2 != 0) {
                this.label = 1;
                obj = extoleInternal2.identifyJwt(this.$jwt, emptyMap, this);
