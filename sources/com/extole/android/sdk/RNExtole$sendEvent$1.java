...
@DebugMetadata(c = "com.extole.android.sdk.RNExtole$sendEvent$1", f = "RNExtole.kt", i = {}, l = {93}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
final class RNExtole$sendEvent$1 extends SuspendLambda implements Function1<Continuation<? super String>, Object> {
    ...
    RNExtole$sendEvent$1(RNExtole rNExtole, ReadableMap readableMap, String str, Continuation<? super RNExtole$sendEvent$1> continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new RNExtole$sendEvent$1(this.this$0, this.$data, this.$eventName, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super String> continuation) {
        return ((RNExtole$sendEvent$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (extoleInternal2 != null) {
                this.label = 1;
                obj = Extole.DefaultImpls.sendEvent$default(extoleInternal2, this.$eventName, map, null, this, 4, null);
