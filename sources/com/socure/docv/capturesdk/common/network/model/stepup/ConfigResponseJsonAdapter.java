...
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eH\u0016J\u001a\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0002H\u0016J\b\u0010\u0014\u001a\u00020\u000bH\u0016R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00070\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0001X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lcom/socure/docv/capturesdk/common/network/model/stepup/ConfigResponseJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/socure/docv/capturesdk/common/network/model/stepup/ConfigResponse;", "moshi", "Lcom/squareup/moshi/Moshi;", "(Lcom/squareup/moshi/Moshi;)V", "configDataAdapter", "Lcom/socure/docv/capturesdk/common/network/model/stepup/ConfigData;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "toString", "capturesdk_productionRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class ConfigResponseJsonAdapter extends JsonAdapter<ConfigResponse> {
    private final JsonAdapter<ConfigData> configDataAdapter;
    ...
    public ConfigResponseJsonAdapter(Moshi moshi) {
        ...
        this.configDataAdapter = a.a(moshi, ConfigData.class, "data", "moshi.adapter(ConfigData…      emptySet(), \"data\")");
    }
    ...
    public ConfigResponse fromJson(JsonReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            } else if (selectName == 1 && (configData = this.configDataAdapter.fromJson(reader)) == null) {
        ...
        if (configData != null) {
            return new ConfigResponse(str, configData);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter writer, ConfigResponse value_) {
        ...
        writer.name("data");
        this.configDataAdapter.toJson(writer, (JsonWriter) value_.getData());
        writer.endObject();
    }

    public String toString() {
        return b.a(new StringBuilder(36), "GeneratedJsonAdapter(", "ConfigResponse", ')', "StringBuilder(capacity).…builderAction).toString()");
    }
}
