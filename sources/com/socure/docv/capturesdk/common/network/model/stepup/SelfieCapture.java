...
public final /* data */ class SelfieCapture {
    ...
    public SelfieCapture(Label header, Label errorTextSecondary, Label manualCapturePrimaryText, Label manualCaptureSecondaryText, Label photoAlignmentText) {
        Intrinsics.checkNotNullParameter(header, "header");
        Intrinsics.checkNotNullParameter(errorTextSecondary, "errorTextSecondary");
        ...
        Intrinsics.checkNotNullParameter(photoAlignmentText, "photoAlignmentText");
        this.header = header;
