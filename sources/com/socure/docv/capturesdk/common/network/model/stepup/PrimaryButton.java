...
public final /* data */ class PrimaryButton {
    ...
    public PrimaryButton(String color, String backgroundColor, String fontSize, String fontWeight, String borderRadius, String borderColor, String borderWidth, String shadow, String width) {
    ...
    public final PrimaryButton copy(String color, String backgroundColor, String fontSize, String fontWeight, String borderRadius, String borderColor, String borderWidth, String shadow, String width) {
        Intrinsics.checkNotNullParameter(color, "color");
        Intrinsics.checkNotNullParameter(backgroundColor, "backgroundColor");
        Intrinsics.checkNotNullParameter(fontSize, "fontSize");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.color, primaryButton.color) && Intrinsics.areEqual(this.backgroundColor, primaryButton.backgroundColor) && Intrinsics.areEqual(this.fontSize, primaryButton.fontSize) && Intrinsics.areEqual(this.fontWeight, primaryButton.fontWeight) && Intrinsics.areEqual(this.borderRadius, primaryButton.borderRadius) && Intrinsics.areEqual(this.borderColor, primaryButton.borderColor) && Intrinsics.areEqual(this.borderWidth, primaryButton.borderWidth) && Intrinsics.areEqual(this.shadow, primaryButton.shadow) && Intrinsics.areEqual(this.width, primaryButton.width);
    }
    ...
    public String toString() {
        return "PrimaryButton(color=" + this.color + ", backgroundColor=" + this.backgroundColor + ", fontSize=" + this.fontSize + ", fontWeight=" + this.fontWeight + ", borderRadius=" + this.borderRadius + ", borderColor=" + this.borderColor + ", borderWidth=" + this.borderWidth + ", shadow=" + this.shadow + ", width=" + this.width + ")";
    }
}
