...
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\f\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eH\u0016J\u001a\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00122\b\u0010\u0013\u001a\u0004\u0018\u00010\u0002H\u0016J\b\u0010\u0014\u001a\u00020\u000bH\u0016R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00070\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0001X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, d2 = {"Lcom/socure/docv/capturesdk/common/network/model/stepup/FlowResponseJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/socure/docv/capturesdk/common/network/model/stepup/FlowResponse;", "moshi", "Lcom/squareup/moshi/Moshi;", "(Lcom/squareup/moshi/Moshi;)V", "flowDataAdapter", "Lcom/socure/docv/capturesdk/common/network/model/stepup/FlowData;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "toString", "capturesdk_productionRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class FlowResponseJsonAdapter extends JsonAdapter<FlowResponse> {
    private final JsonAdapter<FlowData> flowDataAdapter;
    private final JsonReader.Options options;
    private final JsonAdapter<String> stringAdapter;

    public FlowResponseJsonAdapter(Moshi moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        JsonReader.Options of = JsonReader.Options.of("data", "status");
        Intrinsics.checkNotNullExpressionValue(of, "of(\"data\", \"status\")");
        this.options = of;
        this.flowDataAdapter = a.a(moshi, FlowData.class, "data", "moshi.adapter(FlowData::…      emptySet(), \"data\")");
        this.stringAdapter = a.a(moshi, String.class, "status", "moshi.adapter(String::cl…ptySet(),\n      \"status\")");
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.squareup.moshi.JsonAdapter
    public FlowResponse fromJson(JsonReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                flowData = this.flowDataAdapter.fromJson(reader);
                if (flowData == null) {
        ...
        if (str != null) {
            return new FlowResponse(flowData, str);
        }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter writer, FlowResponse value_) {
        ...
        writer.beginObject();
        writer.name("data");
        this.flowDataAdapter.toJson(writer, (JsonWriter) value_.getData());
        writer.name("status");
    ...
    public String toString() {
        return b.a(new StringBuilder(34), "GeneratedJsonAdapter(", "FlowResponse", ')', "StringBuilder(capacity).…builderAction).toString()");
    }
}
