...
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\u0010\u0010\u0010\u001a\u00020\u00022\u0006\u0010\u0011\u001a\u00020\u0012H\u0016J\u001a\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u00162\b\u0010\u0017\u001a\u0004\u0018\u00010\u0002H\u0016J\b\u0010\u0018\u001a\u00020\rH\u0016R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00070\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\f\u001a\b\u0012\u0004\u0012\u00020\r0\u0001X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u000f0\u0001X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Lcom/socure/docv/capturesdk/common/network/model/stepup/UploadEndDataJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/socure/docv/capturesdk/common/network/model/stepup/UploadEndData;", "moshi", "Lcom/squareup/moshi/Moshi;", "(Lcom/squareup/moshi/Moshi;)V", "booleanAdapter", "", "intAdapter", "", "options", "Lcom/squareup/moshi/JsonReader$Options;", "stringAdapter", "", "uploadEndEnvironmentAdapter", "Lcom/socure/docv/capturesdk/common/network/model/stepup/UploadEndEnvironment;", "fromJson", "reader", "Lcom/squareup/moshi/JsonReader;", "toJson", "", "writer", "Lcom/squareup/moshi/JsonWriter;", "value_", "toString", "capturesdk_productionRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes5.dex */
public final class UploadEndDataJsonAdapter extends JsonAdapter<UploadEndData> {
    private final JsonAdapter<Boolean> booleanAdapter;
    private final JsonAdapter<Integer> intAdapter;
    private final JsonReader.Options options;
    private final JsonAdapter<String> stringAdapter;
    private final JsonAdapter<UploadEndEnvironment> uploadEndEnvironmentAdapter;

    public UploadEndDataJsonAdapter(Moshi moshi) {
        ...
        this.uploadEndEnvironmentAdapter = a.a(moshi, UploadEndEnvironment.class, "environment", "moshi.adapter(UploadEndE…mptySet(), \"environment\")");
    }

    /* JADX WARN: Can't rename method to resolve collision */
    @Override // com.squareup.moshi.JsonAdapter
    public UploadEndData fromJson(JsonReader reader) {
        ...
        String str7 = null;
        String str8 = null;
        UploadEndEnvironment uploadEndEnvironment = null;
        String str9 = null;
        String str10 = null;
        while (true) {
            Integer num3 = num2;
            Boolean bool3 = bool2;
            UploadEndEnvironment uploadEndEnvironment2 = uploadEndEnvironment;
            String str11 = str8;
            Integer num4 = num;
            Boolean bool4 = bool;
            String str12 = str7;
            ...
            if (!reader.hasNext()) {
                ...
                if (str10 != null) {
                    return new UploadEndData(str18, str17, str16, str15, str14, str13, str12, booleanValue, intValue, str11, uploadEndEnvironment2, booleanValue2, intValue2, str9, str10);
                }
            ...
            switch (reader.selectName(this.options)) {
                case -1:
                    ...
                    num2 = num3;
                    bool2 = bool3;
                    uploadEndEnvironment = uploadEndEnvironment2;
                    str8 = str11;
                    num = num4;
                    bool = bool4;
                    str7 = str12;
                ...
                case 9:
                    ...
                    str = str18;
                case 10:
                    uploadEndEnvironment = this.uploadEndEnvironmentAdapter.fromJson(reader);
                    if (uploadEndEnvironment == null) {
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter writer, UploadEndData value_) {
        ...
        this.uploadEndEnvironmentAdapter.toJson(writer, (JsonWriter) value_.getEnvironment());
        writer.name("expired");
    ...
    public String toString() {
        return b.a(new StringBuilder(35), "GeneratedJsonAdapter(", "UploadEndData", ')', "StringBuilder(capacity).…builderAction).toString()");
    }
}
