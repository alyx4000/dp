...
public final /* data */ class UploadStatusData {
    ...
    public UploadStatusData(String eventId, String verificationLevel, String publicAccountId, String publicApiKey, String flowVersion, String flowName, String token, boolean z, int i, String createdAt, Environment environment, boolean z2, int i2, String publicId, String updatedAt) {
    ...
    public final UploadStatusData copy(String eventId, String verificationLevel, String publicAccountId, String publicApiKey, String flowVersion, String flowName, String token, boolean isInternal, int accountId, String createdAt, Environment environment, boolean expired, int id, String publicId, String updatedAt) {
        Intrinsics.checkNotNullParameter(eventId, "eventId");
        Intrinsics.checkNotNullParameter(verificationLevel, "verificationLevel");
        Intrinsics.checkNotNullParameter(publicAccountId, "publicAccountId");
        Intrinsics.checkNotNullParameter(publicApiKey, "publicApiKey");
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.eventId, uploadStatusData.eventId) && Intrinsics.areEqual(this.verificationLevel, uploadStatusData.verificationLevel) && Intrinsics.areEqual(this.publicAccountId, uploadStatusData.publicAccountId) && Intrinsics.areEqual(this.publicApiKey, uploadStatusData.publicApiKey) && Intrinsics.areEqual(this.flowVersion, uploadStatusData.flowVersion) && Intrinsics.areEqual(this.flowName, uploadStatusData.flowName) && Intrinsics.areEqual(this.token, uploadStatusData.token) && this.isInternal == uploadStatusData.isInternal && this.accountId == uploadStatusData.accountId && Intrinsics.areEqual(this.createdAt, uploadStatusData.createdAt) && Intrinsics.areEqual(this.environment, uploadStatusData.environment) && this.expired == uploadStatusData.expired && this.id == uploadStatusData.id && Intrinsics.areEqual(this.publicId, uploadStatusData.publicId) && Intrinsics.areEqual(this.updatedAt, uploadStatusData.updatedAt);
    }
