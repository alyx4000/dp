...
public final class c implements com.socure.docv.capturesdk.core.processor.interfaces.a {
    ...
    public final com.socure.docv.capturesdk.di.c f361a;
    public final Model b;

    public c(com.socure.docv.capturesdk.di.c dependencyGraph) {
        Intrinsics.checkNotNullParameter(dependencyGraph, "dependencyGraph");
        this.f361a = dependencyGraph;
        this.b = dependencyGraph.b().a();
    }

    @Override // com.socure.docv.capturesdk.core.processor.interfaces.a
    public void a() {
        this.b.getModel().close();
    }
