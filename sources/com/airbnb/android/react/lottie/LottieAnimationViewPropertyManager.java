    ...
    public LottieAnimationViewPropertyManager(final LottieAnimationView view) {
        ...
        view.setFontAssetDelegate(new FontAssetDelegate() { // from class: com.airbnb.android.react.lottie.LottieAnimationViewPropertyManager.1
            ...
            public Typeface fetchFont(String fontFamily) {
                ...
                Intrinsics.checkNotNullExpressionValue(typeface, "getInstance()\n          …SET, view.context.assets)");
                return typeface;
            }
    ...
    public final void commitChanges() {
        ...
        if (str3 != null) {
            ...
            try {
                ...
                m1227constructorimpl = Result.m1227constructorimpl(Uri.parse(str3).getScheme());
            } catch (Throwable th) {
            ...
            if (((String) m1227constructorimpl) != null) {
                lottieAnimationView.setAnimationFromUrl(str3);
                this.sourceDotLottie = null;
                return;
            }
            int identifier = lottieAnimationView.getResources().getIdentifier(str3, IterableConstants.SOUND_FOLDER_IDENTIFIER, lottieAnimationView.getContext().getPackageName());
            if (identifier == 0) {
