...
public class LottieAnimationView extends AppCompatImageView {
        ...
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return LottieAnimationView.this.m358lambda$fromRawRes$1$comairbnblottieLottieAnimationView(i);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m358lambda$fromRawRes$1$comairbnblottieLottieAnimationView(int i) throws Exception {
    ...
    private LottieTask<LottieComposition> fromAssets(final String str) {
        if (isInEditMode()) {
            return new LottieTask<>(new Callable() { // from class: com.airbnb.lottie.LottieAnimationView$$ExternalSyntheticLambda2
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return LottieAnimationView.this.m357lambda$fromAssets$2$comairbnblottieLottieAnimationView(str);
                }
            }, true);
        }
    ...
    /* synthetic */ LottieResult m357lambda$fromAssets$2$comairbnblottieLottieAnimationView(String str) throws Exception {
