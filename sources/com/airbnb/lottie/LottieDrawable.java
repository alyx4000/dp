...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    /* synthetic */ void m360lambda$new$0$comairbnblottieLottieDrawable(ValueAnimator valueAnimator) {
    ...
    /* synthetic */ void m362lambda$new$2$comairbnblottieLottieDrawable() {
        CompositionLayer compositionLayer = this.compositionLayer;
        if (compositionLayer == null) {
            return;
        }
                ...
                if (this.mainThreadHandler == null) {
                    ...
                    this.invalidateSelfRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda3
                        ...
                        public final void run() {
                            LottieDrawable.this.m361lambda$new$1$comairbnblottieLottieDrawable();
                        }
                    };
                }
    ...
    /* synthetic */ void m361lambda$new$1$comairbnblottieLottieDrawable() {
    ...
    public LottieDrawable() {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                LottieDrawable.this.m360lambda$new$0$comairbnblottieLottieDrawable(valueAnimator);
            }
        };
        ...
        this.updateProgressRunnable = new Runnable() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                LottieDrawable.this.m362lambda$new$2$comairbnblottieLottieDrawable();
            }
        };
        ...
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda5
                ...
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m363lambda$playAnimation$3$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m363lambda$playAnimation$3$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        playAnimation();
    }
    ...
    public void resumeAnimation() {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda15
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m364lambda$resumeAnimation$4$comairbnblottieLottieDrawable(lottieComposition);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m364lambda$resumeAnimation$4$comairbnblottieLottieDrawable(LottieComposition lottieComposition) {
        resumeAnimation();
    }
    ...
    public void setMinFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda12
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m373lambda$setMinFrame$5$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* synthetic */ void m373lambda$setMinFrame$5$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMinFrame(i);
    }
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda13
                ...
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m375lambda$setMinProgress$6$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* synthetic */ void m375lambda$setMinProgress$6$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMinProgress(f);
    }
    ...
    public void setMaxFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda14
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m367lambda$setMaxFrame$7$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* synthetic */ void m367lambda$setMaxFrame$7$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setMaxFrame(i);
    }
    ...
    public void setMaxProgress(final float f) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda4
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m368lambda$setMaxProgress$8$comairbnblottieLottieDrawable(f, lottieComposition2);
                }
            });
        } else {
    ...
    /* synthetic */ void m368lambda$setMaxProgress$8$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setMaxProgress(f);
    }
    ...
    public void setMinFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda1
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m374lambda$setMinFrame$9$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m374lambda$setMinFrame$9$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMinFrame(str);
    }
    ...
    public void setMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda16
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m366lambda$setMaxFrame$10$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m366lambda$setMaxFrame$10$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
        setMaxFrame(str);
    }
    ...
    public void setMinAndMaxFrame(final String str) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda8
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m369lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(str, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m369lambda$setMinAndMaxFrame$11$comairbnblottieLottieDrawable(String str, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final String str, final String str2, final boolean z) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda17
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m370lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(str, str2, z, lottieComposition2);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m370lambda$setMinAndMaxFrame$12$comairbnblottieLottieDrawable(String str, String str2, boolean z, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxFrame(final int i, final int i2) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda7
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m371lambda$setMinAndMaxFrame$13$comairbnblottieLottieDrawable(i, i2, lottieComposition);
                }
            });
        } else {
    ...
    /* synthetic */ void m371lambda$setMinAndMaxFrame$13$comairbnblottieLottieDrawable(int i, int i2, LottieComposition lottieComposition) {
    ...
    public void setMinAndMaxProgress(final float f, final float f2) {
        ...
        if (lottieComposition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda11
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition2) {
                    LottieDrawable.this.m372lambda$setMinAndMaxProgress$14$comairbnblottieLottieDrawable(f, f2, lottieComposition2);
                }
            });
        } else {
    ...
    /* synthetic */ void m372lambda$setMinAndMaxProgress$14$comairbnblottieLottieDrawable(float f, float f2, LottieComposition lottieComposition) {
    ...
    public void setFrame(final int i) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda6
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m365lambda$setFrame$15$comairbnblottieLottieDrawable(i, lottieComposition);
                }
            });
        } else {
    ...
    /* synthetic */ void m365lambda$setFrame$15$comairbnblottieLottieDrawable(int i, LottieComposition lottieComposition) {
        setFrame(i);
    }
    ...
    public void setProgress(final float f) {
        if (this.composition == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda10
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m376lambda$setProgress$16$comairbnblottieLottieDrawable(f, lottieComposition);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m376lambda$setProgress$16$comairbnblottieLottieDrawable(float f, LottieComposition lottieComposition) {
        setProgress(f);
    }
    ...
    public <T> void addValueCallback(final KeyPath keyPath, final T t, final LottieValueCallback<T> lottieValueCallback) {
        if (this.compositionLayer == null) {
            this.lazyCompositionTasks.add(new LazyCompositionTask() { // from class: com.airbnb.lottie.LottieDrawable$$ExternalSyntheticLambda2
                @Override // com.airbnb.lottie.LottieDrawable.LazyCompositionTask
                public final void run(LottieComposition lottieComposition) {
                    LottieDrawable.this.m359lambda$addValueCallback$17$comairbnblottieLottieDrawable(keyPath, t, lottieValueCallback, lottieComposition);
                }
            });
            return;
        }
    ...
    /* synthetic */ void m359lambda$addValueCallback$17$comairbnblottieLottieDrawable(KeyPath keyPath, Object obj, LottieValueCallback lottieValueCallback, LottieComposition lottieComposition) {
