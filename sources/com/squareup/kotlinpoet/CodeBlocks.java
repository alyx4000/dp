...
public final class CodeBlocks {
    ...
    public static final CodeBlock joinToCode(Collection<CodeBlock> collection, CharSequence separator) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        Intrinsics.checkNotNullParameter(separator, "separator");
        return joinToCode$default(collection, separator, null, null, 6, null);
    }

    public static final CodeBlock joinToCode(Collection<CodeBlock> collection, CharSequence separator, CharSequence prefix) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        Intrinsics.checkNotNullParameter(separator, "separator");
    ...
    public static final CodeBlock buildCodeBlock(Function1<? super CodeBlock.Builder, Unit> builderAction) {
    ...
    public static final CodeBlock.Builder withIndent(CodeBlock.Builder builder, Function1<? super CodeBlock.Builder, Unit> builderAction) {
    ...
    public static final CodeBlock joinToCode(Collection<CodeBlock> collection, CharSequence separator, CharSequence prefix, CharSequence suffix) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        Intrinsics.checkNotNullParameter(separator, "separator");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        ...
        return CodeBlock.INSTANCE.of(ArraysKt.joinToString$default(strArr, separator, prefix, suffix, 0, (CharSequence) null, (Function1) null, 56, (Object) null), Arrays.copyOf(codeBlockArr, codeBlockArr.length));
    }
}
