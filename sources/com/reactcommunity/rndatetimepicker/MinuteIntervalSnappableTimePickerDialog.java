...
class MinuteIntervalSnappableTimePickerDialog extends TimePickerDialog {
    ...
    public boolean pickerIsInTextInputMode() {
        View findViewById = findViewById(this.mContext.getResources().getIdentifier("input_mode", "id", AndroidContextProvider.OS_NAME));
    ...
    public void onAttachedToWindow() {
        ...
        this.mTimePicker = (TimePicker) findViewById(this.mContext.getResources().getIdentifier("timePicker", "id", AndroidContextProvider.OS_NAME));
        if (timePickerHasCustomMinuteInterval()) {
            setupPickerDialog();
        }
    }
    ...
    private void setSpinnerDisplayedValues() {
        NumberPicker numberPicker = (NumberPicker) findViewById(this.mContext.getResources().getIdentifier("minute", "id", AndroidContextProvider.OS_NAME));
