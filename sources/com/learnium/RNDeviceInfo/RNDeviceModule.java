...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        hashMap.put(IterableConstants.DEVICE_ID, Build.BOARD);
        hashMap.put("bundleId", getReactApplicationContext().getPackageName());
        hashMap.put(IterableConstants.DEVICE_SYSTEM_NAME, "Android");
    ...
    public boolean isLocationEnabledSync() {
        if (Build.VERSION.SDK_INT >= 28) {
            try {
                return ((LocationManager) getReactApplicationContext().getSystemService(IterableConstants.ITERABLE_IN_APP_LOCATION)).isLocationEnabled();
            } catch (Exception unused) {
    ...
    public WritableMap getAvailableLocationProvidersSync() {
        LocationManager locationManager = (LocationManager) getReactApplicationContext().getSystemService(IterableConstants.ITERABLE_IN_APP_LOCATION);
