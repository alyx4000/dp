...
public class DeviceIdResolver {
    ...
    String getGmsInstanceId() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Object invoke = Class.forName(IterableConstants.INSTANCE_ID_CLASS).getDeclaredMethod("getInstance", Context.class).invoke(null, this.context.getApplicationContext());
