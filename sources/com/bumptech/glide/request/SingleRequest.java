    ...
    */
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r7, com.bumptech.glide.load.DataSource r8, boolean r9) {
        /*
            ...
            r2.throwIfRecycled()
            r2 = 0
            java.lang.Object r3 = r6.requestLock     // Catch: java.lang.Throwable -> Lc5
            monitor-enter(r3)     // Catch: java.lang.Throwable -> Lc5
            r6.loadStatus = r2     // Catch: java.lang.Throwable -> Lc2
            if (r7 != 0) goto L30
            com.bumptech.glide.load.engine.GlideException r7 = new com.bumptech.glide.load.engine.GlideException     // Catch: java.lang.Throwable -> Lc2
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> Lc2
            r8.<init>(r1)     // Catch: java.lang.Throwable -> Lc2
            java.lang.Class<R> r9 = r6.transcodeClass     // Catch: java.lang.Throwable -> Lc2
            ...
            r6.onLoadFailed(r7)     // Catch: java.lang.Throwable -> Lc2
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lc2
            return
        L30:
            java.lang.Object r1 = r7.get()     // Catch: java.lang.Throwable -> Lc2
            if (r1 == 0) goto L64
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch: java.lang.Throwable -> Lc2
            java.lang.Class r5 = r1.getClass()     // Catch: java.lang.Throwable -> Lc2
            boolean r4 = r4.isAssignableFrom(r5)     // Catch: java.lang.Throwable -> Lc2
            if (r4 != 0) goto L43
            goto L64
        L43:
            boolean r0 = r6.canSetResource()     // Catch: java.lang.Throwable -> Lc2
            if (r0 != 0) goto L5f
            r6.resource = r2     // Catch: java.lang.Throwable -> Lbe
            com.bumptech.glide.request.SingleRequest$Status r8 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch: java.lang.Throwable -> Lbe
            r6.status = r8     // Catch: java.lang.Throwable -> Lbe
            java.lang.String r8 = "GlideRequest"
            int r9 = r6.cookie     // Catch: java.lang.Throwable -> Lbe
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r8, r9)     // Catch: java.lang.Throwable -> Lbe
        ...
        L5e:
            return
        L5f:
            r6.onResourceReady(r7, r1, r8, r9)     // Catch: java.lang.Throwable -> Lc2
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lc2
            return
        L64:
            r6.resource = r2     // Catch: java.lang.Throwable -> Lbe
            com.bumptech.glide.load.engine.GlideException r8 = new com.bumptech.glide.load.engine.GlideException     // Catch: java.lang.Throwable -> Lbe
            ...
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch: java.lang.Throwable -> Lbe
            java.lang.String r0 = " but instead got "
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch: java.lang.Throwable -> Lbe
            if (r1 == 0) goto L80
            java.lang.Class r0 = r1.getClass()     // Catch: java.lang.Throwable -> Lbe
            goto L82
        L80:
            java.lang.String r0 = ""
        L82:
            ...
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch: java.lang.Throwable -> Lbe
            java.lang.StringBuilder r9 = r9.append(r7)     // Catch: java.lang.Throwable -> Lbe
            java.lang.String r0 = "}."
            java.lang.StringBuilder r9 = r9.append(r0)     // Catch: java.lang.Throwable -> Lbe
            if (r1 == 0) goto La5
            java.lang.String r0 = ""
        ...
        La7:
            ...
            r6.onLoadFailed(r8)     // Catch: java.lang.Throwable -> Lbe
            monitor-exit(r3)     // Catch: java.lang.Throwable -> Lbe
            if (r7 == 0) goto Lbd
            com.bumptech.glide.load.engine.Engine r8 = r6.engine
            r8.release(r7)
    ...
    private void onResourceReady(Resource<R> resource, R r, DataSource dataSource, boolean z) {
        ...
        if (this.glideContext.getLogLevel() <= 3) {
            Log.d(GLIDE_TAG, "Finished loading " + r.getClass().getSimpleName() + " from " + dataSource + " for " + this.model + " with size [" + this.width + ViewHierarchyNode.JsonKeys.X + this.height + "] in " + LogTime.getElapsedMillis(this.startTime) + " ms");
        }
    ...
    private void onLoadFailed(GlideException glideException, int i) {
        ...
        synchronized (this.requestLock) {
            ...
            if (logLevel <= i) {
                Log.w(GLIDE_TAG, "Load failed for [" + this.model + "] with dimensions [" + this.width + ViewHierarchyNode.JsonKeys.X + this.height + "]", glideException);
                if (logLevel <= 4) {
