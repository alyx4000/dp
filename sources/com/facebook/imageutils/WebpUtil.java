...
public final class WebpUtil {
    ...
    private final Pair<Integer, Integer> getVP8LDimension(InputStream stream) throws IOException {
        ...
        return new Pair<>(Integer.valueOf((read | ((read2 & 63) << 8)) + 1), Integer.valueOf(((((stream.read() & 255) & 15) << 10) | ((stream.read() & 255) << 2) | ((read2 & 192) >> 6)) + 1));
    }
    ...
    private final String getHeader(byte[] header) {
        ...
        for (byte b : header) {
            sb.append((char) (UShort.m1508constructorimpl(b) & UShort.MAX_VALUE));
        }
