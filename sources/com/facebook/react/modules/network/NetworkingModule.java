    ...
    public void sendRequestInternal(String str, String str2, final int i, ReadableArray readableArray, ReadableMap readableMap, final String str3, final boolean z, int i2, boolean z2) {
        ...
        try {
            ...
            try {
                ...
                addRequest(i);
                FirebasePerfOkHttpClient.enqueue(build.newCall(url.build()), new Callback() { // from class: com.facebook.react.modules.network.NetworkingModule.2
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            if (HttpRequest.ENCODING_GZIP.equalsIgnoreCase(response.header(HttpRequest.HEADER_CONTENT_ENCODING)) && body != null) {
