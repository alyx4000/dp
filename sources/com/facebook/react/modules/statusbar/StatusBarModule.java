...
public class StatusBarModule extends NativeStatusBarManagerAndroidSpec {
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        return MapBuilder.of(HEIGHT_KEY, Float.valueOf(reactApplicationContext.getResources().getIdentifier("status_bar_height", "dimen", AndroidContextProvider.OS_NAME) > 0 ? PixelUtil.toDIPFromPixel(reactApplicationContext.getResources().getDimensionPixelSize(r2)) : 0.0f), DEFAULT_BACKGROUND_COLOR_KEY, currentActivity != null ? String.format("#%06X", Integer.valueOf(currentActivity.getWindow().getStatusBarColor() & ViewCompat.MEASURED_SIZE_MASK)) : "black");
    }
