...
public abstract class DevSupportManagerBase implements DevSupportManager {
    ...
    public DevSupportManagerBase(Context context, ReactInstanceDevHelper reactInstanceDevHelper, String str, boolean z, RedBoxHandler redBoxHandler, DevBundleDownloadListener devBundleDownloadListener, int i, Map<String, RequestHandler> map, SurfaceDelegateFactory surfaceDelegateFactory, DevLoadingViewManager devLoadingViewManager) {
        ...
        this.mDevServerHelper = new DevServerHelper(devInternalSettings, context.getPackageName(), new InspectorPackagerConnection.BundleStatusProvider() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda19
            ...
            public final InspectorPackagerConnection.BundleStatus getBundleStatus() {
                ...
                lambda$new$0 = DevSupportManagerBase.this.lambda$new$0();
                return lambda$new$0;
            }
    ...
    public void updateJSError(final String str, final ReadableArray readableArray, final int i) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DevSupportManagerBase.this.lambda$updateJSError$1(i, str, readableArray);
            }
        });
    }
    ...
    private void showNewError(final String str, final StackFrame[] stackFrameArr, final int i, final ErrorType errorType) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                DevSupportManagerBase.this.lambda$showNewError$2(str, stackFrameArr, i, errorType);
            }
        });
    }
    ...
    public void showDevOptionsDialog() {
        ...
        if (this.mDevOptionsDialog == null && this.mIsDevSupportEnabled && !ActivityManager.isUserAMonkey()) {
            ...
            linkedHashMap.put(this.mApplicationContext.getString(R.string.catalyst_settings), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda4
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
                    DevSupportManagerBase.this.lambda$showDevOptionsDialog$7();
                }
            });
            ...
            AlertDialog create = new AlertDialog.Builder(currentActivity).setCustomTitle(linearLayout).setItems((CharSequence[]) linkedHashMap.keySet().toArray(new String[0]), new DialogInterface.OnClickListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda5
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    DevSupportManagerBase.this.lambda$showDevOptionsDialog$8(devOptionHandlerArr, dialogInterface, i);
                }
                ...
                public final void onCancel(DialogInterface dialogInterface) {
                    DevSupportManagerBase.this.lambda$showDevOptionsDialog$9(dialogInterface);
                }
            }).create();
    ...
    private void resetCurrentContext(ReactContext reactContext) {
        ...
        if (this.mCurrentContext != null) {
            try {
                ...
                ((HMRClient) this.mCurrentContext.getJSModule(HMRClient.class)).setup(AndroidContextProvider.OS_NAME, url.getPath().substring(1), url.getHost(), url.getPort() != -1 ? url.getPort() : url.getDefaultPort(), this.mDevSettings.isHotModuleReplacementEnabled());
    ...
    public void fetchSplitBundleAndCreateBundleLoader(String str, final CallbackWithBundleLoader callbackWithBundleLoader) {
        ...
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                DevSupportManagerBase.this.lambda$fetchSplitBundleAndCreateBundleLoader$10(devServerSplitBundleURL, file, callbackWithBundleLoader);
            }
        });
    }
    ...
    class AnonymousClass5 implements DevBundleDownloadListener {
        ...
        public void onSuccess() {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.AnonymousClass5.this.lambda$onSuccess$0();
                }
            });
    ...
    public void isPackagerRunning(final PackagerStatusCallback packagerStatusCallback) {
        Runnable runnable = new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                DevSupportManagerBase.this.lambda$isPackagerRunning$11(packagerStatusCallback);
            }
        };
    ...
    public void reloadJSFromServer(String str) {
        reloadJSFromServer(str, new BundleLoadCallback() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda7
            ...
            public final void onSuccess() {
                DevSupportManagerBase.this.lambda$reloadJSFromServer$12();
            }
        });
    }
    ...
    public void reportBundleLoadingFailure(final Exception exc) {
        UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                DevSupportManagerBase.this.lambda$reportBundleLoadingFailure$13(exc);
            }
        });
    }
    ...
    public void setHotModuleReplacementEnabled(final boolean z) {
        if (this.mIsDevSupportEnabled) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.this.lambda$setHotModuleReplacementEnabled$14(z);
                }
            });
        }
    }
    ...
    public void setRemoteJSDebugEnabled(final boolean z) {
        if (this.mIsDevSupportEnabled) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.this.lambda$setRemoteJSDebugEnabled$15(z);
                }
            });
        }
    }
    ...
    public void setFpsDebugEnabled(final boolean z) {
        if (this.mIsDevSupportEnabled) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.this.lambda$setFpsDebugEnabled$16(z);
                }
            });
        }
    }
    ...
    public void toggleElementInspector() {
        if (this.mIsDevSupportEnabled) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.this.lambda$toggleElementInspector$17();
                }
            });
        }
    }
    ...
    class AnonymousClass8 implements DevServerHelper.PackagerCommandListener {
        ...
        public void onPackagerReloadCommand() {
            ...
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$8$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.AnonymousClass8.this.lambda$onPackagerReloadCommand$0();
                }
            });
        }
        ...
        public void onPackagerDevMenuCommand() {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$8$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.AnonymousClass8.this.lambda$onPackagerDevMenuCommand$1();
                }
            });
        }
        ...
        public void onCaptureHeapCommand(final Responder responder) {
            UiThreadUtil.runOnUiThread(new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$8$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    DevSupportManagerBase.AnonymousClass8.this.lambda$onCaptureHeapCommand$2(responder);
                }
            });
        }
