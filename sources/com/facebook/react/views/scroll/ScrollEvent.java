...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    protected WritableMap getEventData() {
        ...
        createMap2.putDouble(ViewHierarchyNode.JsonKeys.X, PixelUtil.toDIPFromPixel(this.mScrollX));
        createMap2.putDouble(ViewHierarchyNode.JsonKeys.Y, PixelUtil.toDIPFromPixel(this.mScrollY));
        ...
        createMap5.putDouble(ViewHierarchyNode.JsonKeys.X, this.mXVelocity);
        createMap5.putDouble(ViewHierarchyNode.JsonKeys.Y, this.mYVelocity);
