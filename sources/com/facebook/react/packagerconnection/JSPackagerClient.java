...
public final class JSPackagerClient implements ReconnectingWebSocket.MessageCallback {
    ...
    public JSPackagerClient(String str, PackagerConnectionSettings packagerConnectionSettings, Map<String, RequestHandler> map, ReconnectingWebSocket.ConnectionCallback connectionCallback) {
        ...
        builder.scheme("ws").encodedAuthority(packagerConnectionSettings.getServerIp()).appendPath("message").appendQueryParameter("device", AndroidInfoHelpers.getFriendlyDeviceName()).appendQueryParameter(App.TYPE, packagerConnectionSettings.getPackageName()).appendQueryParameter("clientid", str);
