...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mIsVertical) {
            drawVerticalBar(canvas, ModuleDescriptor.MODULE_VERSION, this.mBackgroundColor);
            drawVerticalBar(canvas, this.mLevel, this.mColor);
        } else {
            drawHorizontalBar(canvas, ModuleDescriptor.MODULE_VERSION, this.mBackgroundColor);
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int width = ((bounds.width() - (this.mPadding * 2)) * i) / ModuleDescriptor.MODULE_VERSION;
    ...
    private void drawVerticalBar(Canvas canvas, int i, int i2) {
        Rect bounds = getBounds();
        int height = ((bounds.height() - (this.mPadding * 2)) * i) / ModuleDescriptor.MODULE_VERSION;
