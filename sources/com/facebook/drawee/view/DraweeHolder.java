...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("controllerAttached", this.mIsControllerAttached).add("holderAttached", this.mIsHolderAttached).add("drawableVisible", this.mIsVisible).add(DatabaseConstants.EVENT_TABLE_NAME, this.mEventTracker.toString()).toString();
    }
}
