            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method2.getModifiers())) {
                        ...
                        createJvmStaticInObjectCaller = KFunctionImpl.this.getDescriptor().getAnnotations().mo2502findAnnotation(UtilKt.getJVM_STATIC()) != null ? KFunctionImpl.this.createJvmStaticInObjectCaller(method2) : KFunctionImpl.this.createStaticMethodCaller(method2);
                    }
        ...
        this.defaultCaller = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(KFunctionImpl.this.getCaller().mo2499getMember());
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (KFunctionImpl.this.getDescriptor().getAnnotations().mo2502findAnnotation(UtilKt.getJVM_STATIC()) != null) {
