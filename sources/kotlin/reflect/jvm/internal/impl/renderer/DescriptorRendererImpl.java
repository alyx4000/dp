...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo2507getDeclarationDescriptor = typeConstructor.mo2507getDeclarationDescriptor();
        if (mo2507getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo2507getDeclarationDescriptor instanceof ClassDescriptor ? true : mo2507getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo2507getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo2507getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo2507getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ...
        if (annotationClass != null && (mo2501getUnsubstitutedPrimaryConstructor = annotationClass.mo2501getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo2501getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ...
        if (!getIncludePropertyConstant() || (mo2503getCompileTimeInitializer = variableDescriptor.mo2503getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ").append(escape(renderConstant(mo2503getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo2501getUnsubstitutedPrimaryConstructor = classDescriptor.mo2501getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo2501getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo2501getUnsubstitutedPrimaryConstructor.getVisibility();
            Intrinsics.checkNotNullExpressionValue(visibility2, "primaryConstructor.visibility");
            renderVisibility(visibility2, sb);
            sb.append(renderKeyword("constructor"));
            List<ValueParameterDescriptor> valueParameters = mo2501getUnsubstitutedPrimaryConstructor.getValueParameters();
            Intrinsics.checkNotNullExpressionValue(valueParameters, "primaryConstructor.valueParameters");
            renderValueParameters(valueParameters, mo2501getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Intrinsics.checkNotNullExpressionValue(mo2508getSupertypes, "klass.typeConstructor.supertypes");
        if (mo2508getSupertypes.isEmpty()) {
            return;
        }
        if (mo2508getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo2508getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo2508getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            {
                super(1);
            }
