...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo2507getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo2508getSupertypes() {
                Collection<KotlinType> mo2508getSupertypes = mo2507getDeclarationDescriptor().getUnderlyingType().getConstructor().mo2508getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo2508getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo2508getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo2507getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo2507getDeclarationDescriptor().getName().asString() + ']';
            }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor mo2507getDeclarationDescriptor = type.getConstructor().mo2507getDeclarationDescriptor();
                    if ((mo2507getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo2507getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
