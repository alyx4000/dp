...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor mo2507getDeclarationDescriptor = getConstructor().mo2507getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(("Incorrect classifier: " + getConstructor().mo2507getDeclarationDescriptor()).toString());
        }
