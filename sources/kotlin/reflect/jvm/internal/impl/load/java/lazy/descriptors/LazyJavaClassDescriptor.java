...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            while (it.hasNext()) {
                ClassifierDescriptor mo2507getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo2507getDeclarationDescriptor();
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        protected Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo2507getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo2507getDeclarationDescriptor = mo2507getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo2507getDeclarationDescriptor, arrayList5);
            }
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo2502findAnnotation = annotations.mo2502findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public ClassDescriptor mo2507getDeclarationDescriptor() {
