...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2509getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo2509getContributedClassifier = this.javaScope.mo2509getContributedClassifier(name, location);
        if (mo2509getContributedClassifier != null) {
            return mo2509getContributedClassifier;
        }
