...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo2513recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    public ClassifierDescriptor mo2509getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo2509getContributedClassifier(name, location);
