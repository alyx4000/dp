...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> mo2508getSupertypes = this.containingClass.getTypeConstructor().mo2508getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo2508getSupertypes, "containingClass.typeConstructor.supertypes");
