    ...
    public static final TypeSubstitution wrapWithCapturingSubstitution(final TypeSubstitution typeSubstitution, final boolean z) {
        ...
        return new DelegatedTypeSubstitution(typeSubstitution) { // from class: kotlin.reflect.jvm.internal.impl.resolve.calls.inference.CapturedTypeConstructorKt$wrapWithCapturingSubstitution$2
            ...
            public TypeProjection mo2512get(KotlinType key) {
                ...
                TypeProjection mo2512get = super.mo2512get(key);
                if (mo2512get == null) {
                    return null;
                }
                ClassifierDescriptor mo2507getDeclarationDescriptor = key.getConstructor().mo2507getDeclarationDescriptor();
                createCapturedIfNeeded = CapturedTypeConstructorKt.createCapturedIfNeeded(mo2512get, mo2507getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2507getDeclarationDescriptor : null);
