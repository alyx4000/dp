...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(KotlinType kotlinType) {
        ...
        return mo2507getDeclarationDescriptor != null && isInlineClassThatRequiresMangling(mo2507getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType) {
        ClassifierDescriptor mo2507getDeclarationDescriptor = kotlinType.getConstructor().mo2507getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = mo2507getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo2507getDeclarationDescriptor : null;
