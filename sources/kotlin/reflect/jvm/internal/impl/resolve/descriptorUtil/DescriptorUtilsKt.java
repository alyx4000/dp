...
public final class DescriptorUtilsKt {
    ...
    public static final ClassDescriptor resolveTopLevelClass(ModuleDescriptor moduleDescriptor, FqName topLevelClassFqName, LookupLocation location) {
        ...
        ClassifierDescriptor contributedClassifier = memberScope.mo2509getContributedClassifier(shortName, location);
    ...
    public static final ClassDescriptor getSuperClassNotAny(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getDefaultType().getConstructor().mo2508getSupertypes()) {
            if (!KotlinBuiltIns.isAnyOrNullableAny(kotlinType)) {
                ClassifierDescriptor mo2507getDeclarationDescriptor = kotlinType.getConstructor().mo2507getDeclarationDescriptor();
                if (DescriptorUtils.isClassOrEnumClass(mo2507getDeclarationDescriptor)) {
    ...
    public static final ClassDescriptor getAnnotationClass(AnnotationDescriptor annotationDescriptor) {
        ...
        ClassifierDescriptor mo2507getDeclarationDescriptor = annotationDescriptor.getType().getConstructor().mo2507getDeclarationDescriptor();
