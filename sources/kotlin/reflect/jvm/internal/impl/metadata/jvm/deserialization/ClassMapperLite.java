...
public final class ClassMapperLite {
    ...
    private static final String f785kotlin = CollectionsKt.joinToString$default(CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    ...
    static {
        ...
        linkedHashMap.put(f785kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        ...
        for (String str5 : CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f785kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }

    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f785kotlin + IOUtils.DIR_SEPARATOR_UNIX + str, "L" + str2 + ';');
    }
