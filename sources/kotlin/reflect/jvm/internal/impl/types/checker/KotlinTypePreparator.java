    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo2508getSupertypes = capturedTypeConstructorImpl.mo2508getSupertypes();
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> mo2508getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2508getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2508getSupertypes2, 10));
            Iterator<T> it2 = mo2508getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> mo2508getSupertypes3 = intersectionTypeConstructor2.mo2508getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo2508getSupertypes3, 10));
        Iterator<T> it3 = mo2508getSupertypes3.iterator();
        while (it3.hasNext()) {
