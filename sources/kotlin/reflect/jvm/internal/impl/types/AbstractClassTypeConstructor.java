...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public abstract ClassDescriptor mo2507getDeclarationDescriptor();
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2507getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    protected boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2507getDeclarationDescriptor(), classifierDescriptor);
    }

    @Override // kotlin.reflect.jvm.internal.impl.types.AbstractTypeConstructor
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo2507getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo2500getCompanionObjectDescriptor = classDescriptor.mo2500getCompanionObjectDescriptor();
        if (z && mo2500getCompanionObjectDescriptor != null) {
            smartList.add(mo2500getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2507getDeclarationDescriptor())) {
            return null;
        }
