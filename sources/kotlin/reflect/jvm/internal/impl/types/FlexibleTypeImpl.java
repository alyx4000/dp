...
public final class FlexibleTypeImpl extends FlexibleType implements CustomTypeParameter {
    ...
    public boolean isTypeParameter() {
        return (getLowerBound().getConstructor().mo2507getDeclarationDescriptor() instanceof TypeParameterDescriptor) && Intrinsics.areEqual(getLowerBound().getConstructor(), getUpperBound().getConstructor());
    }
