...
public final class KotlinTypeFactory {
    ...
    private final MemberScope computeMemberScope(TypeConstructor typeConstructor, List<? extends TypeProjection> list, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        if (mo2507getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            return ((TypeParameterDescriptor) mo2507getDeclarationDescriptor).getDefaultType().getMemberScope();
        }
        if (mo2507getDeclarationDescriptor instanceof ClassDescriptor) {
            if (kotlinTypeRefiner == null) {
                kotlinTypeRefiner = DescriptorUtilsKt.getKotlinTypeRefiner(DescriptorUtilsKt.getModule(mo2507getDeclarationDescriptor));
            }
            if (list.isEmpty()) {
                return ModuleAwareClassDescriptorKt.getRefinedUnsubstitutedMemberScopeIfPossible((ClassDescriptor) mo2507getDeclarationDescriptor, kotlinTypeRefiner);
            }
            return ModuleAwareClassDescriptorKt.getRefinedMemberScopeIfPossible((ClassDescriptor) mo2507getDeclarationDescriptor, TypeConstructorSubstitution.Companion.create(typeConstructor, list), kotlinTypeRefiner);
        }
        if (mo2507getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            ErrorScopeKind errorScopeKind = ErrorScopeKind.SCOPE_FOR_ABBREVIATION_TYPE;
            String name = ((TypeAliasDescriptor) mo2507getDeclarationDescriptor).getName().toString();
        ...
        throw new IllegalStateException("Unsupported classifier: " + mo2507getDeclarationDescriptor + " for constructor: " + typeConstructor);
    }
    ...
    public static final SimpleType simpleType(final TypeAttributes attributes, final TypeConstructor constructor, final List<? extends TypeProjection> arguments, final boolean z, KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Intrinsics.checkNotNullParameter(constructor, "constructor");
        Intrinsics.checkNotNullParameter(arguments, "arguments");
        if (attributes.isEmpty() && arguments.isEmpty() && !z && constructor.mo2507getDeclarationDescriptor() != null) {
            ClassifierDescriptor mo2507getDeclarationDescriptor = constructor.mo2507getDeclarationDescriptor();
            Intrinsics.checkNotNull(mo2507getDeclarationDescriptor);
            SimpleType defaultType = mo2507getDeclarationDescriptor.getDefaultType();
    ...
    public final ExpandedTypeOrRefinedConstructor refineConstructor(TypeConstructor typeConstructor, KotlinTypeRefiner kotlinTypeRefiner, List<? extends TypeProjection> list) {
        ...
        ClassifierDescriptor mo2507getDeclarationDescriptor = typeConstructor.mo2507getDeclarationDescriptor();
        if (mo2507getDeclarationDescriptor == null || (refineDescriptor = kotlinTypeRefiner.refineDescriptor(mo2507getDeclarationDescriptor)) == null) {
            return null;
        }
