...
public final class ReflectJvmMapping {
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        Object mo2499getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo2499getMember();
        if (mo2499getMember instanceof Method) {
            return (Method) mo2499getMember;
        }
        return null;
    }
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        KCallableImpl<?> asKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Object mo2499getMember = (asKCallableImpl == null || (caller = asKCallableImpl.getCaller()) == null) ? null : caller.mo2499getMember();
        if (mo2499getMember instanceof Constructor) {
            return (Constructor) mo2499getMember;
        }
        return null;
    }
