    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo2507getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2507getDeclarationDescriptor();
                classDescriptor = mo2507getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2507getDeclarationDescriptor : null;
