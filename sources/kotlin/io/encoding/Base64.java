    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i3 == i && i5 + 3 < endIndex) {
                int i6 = i5 + 1;
                int i7 = iArr[source[i5] & UByte.MAX_VALUE];
                int i8 = i6 + 1;
                int i9 = iArr[source[i6] & UByte.MAX_VALUE];
                int i10 = i8 + 1;
                int i11 = iArr[source[i8] & UByte.MAX_VALUE];
                int i12 = i10 + 1;
                int i13 = (i11 << 6) | (i7 << 18) | (i9 << 12) | iArr[source[i10] & UByte.MAX_VALUE];
                if (i13 >= 0) {
                    int i14 = i2 + 1;
