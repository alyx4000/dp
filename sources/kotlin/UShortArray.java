...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m1559boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m1561constructorimpl(short[] storage) {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m1574containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m1560constructorimpl(int i) {
        return m1561constructorimpl(new short[i]);
    }

    /* renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m1566getMh2AYeg(short[] sArr, int i) {
        return UShort.m1508constructorimpl(sArr[i]);
    }

    /* renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m1571set01HTLdE(short[] sArr, int i, short s) {
        sArr[i] = s;
    }

    /* renamed from: getSize-impl, reason: not valid java name */
    public static int m1567getSizeimpl(short[] sArr) {
        return sArr.length;
    }
    ...
    public static java.util.Iterator<UShort> m1570iteratorimpl(short[] sArr) {
    ...
    /* compiled from: UShortArray.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010(\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0017\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\r\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\t\u0010\b\u001a\u00020\tH\u0096\u0002J\u0013\u0010\n\u001a\u00020\u0002H\u0096\u0002ø\u0001\u0000¢\u0006\u0004\b\u000b\u0010\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u000e¢\u0006\u0002\n\u0000\u0082\u0002\u0004\n\u0002\b!¨\u0006\r"}, d2 = {"Lkotlin/UShortArray$Iterator;", "", "Lkotlin/UShort;", "array", "", "([S)V", "index", "", "hasNext", "", ES6Iterator.NEXT_METHOD, "next-Mh2AYeg", "()S", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = 48)
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m1502boximpl(m1576nextMh2AYeg());
        }
    ...
    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m1562containsxj2QHRw(short[] sArr, short s) {
    ...
    public static boolean m1563containsAllimpl(short[] sArr, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m1569isEmptyimpl(short[] sArr) {
