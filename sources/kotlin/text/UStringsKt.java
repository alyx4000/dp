...
public final class UStringsKt {
    ...
    public static final String m2555toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2557toStringolVBNx4(short s, int i) {
    ...
    public static final String m2556toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2554toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m1322constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m1239boximpl(UByte.m1245constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m1322constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1502boximpl(UShort.m1508constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m1322constructorimpl = UInt.m1322constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = Integer.divideUnsigned(-1, m1322constructorimpl);
                    if (Integer.compareUnsigned(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int m1322constructorimpl2 = UInt.m1322constructorimpl(i3 * m1322constructorimpl);
            int m1322constructorimpl3 = UInt.m1322constructorimpl(UInt.m1322constructorimpl(digitOf) + m1322constructorimpl2);
            if (Integer.compareUnsigned(m1322constructorimpl3, m1322constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = m1322constructorimpl3;
        }
        return UInt.m1316boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m1401constructorimpl = ULong.m1401constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = Long.divideUnsigned(-1L, m1401constructorimpl);
                    if (Long.compareUnsigned(j, j2) > 0) {
                    }
                }
                return null;
            }
            long m1401constructorimpl2 = ULong.m1401constructorimpl(j * m1401constructorimpl);
            long m1401constructorimpl3 = ULong.m1401constructorimpl(ULong.m1401constructorimpl(UInt.m1322constructorimpl(r13) & BodyPartID.bodyIdMax) + m1401constructorimpl2);
            if (Long.compareUnsigned(m1401constructorimpl3, m1401constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = m1401constructorimpl3;
        }
        return ULong.m1395boximpl(j);
    }
}
