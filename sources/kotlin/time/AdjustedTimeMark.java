...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2559minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2705minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2558elapsedNowUwyO8pc() {
        return Duration.m2603minusLRDsOJo(this.mark.mo2558elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2561plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2604plusLRDsOJo(this.adjustment, duration), null);
    }
}
