...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2726copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2728copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m2728copyRFiDyg4(T value, long duration) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m2573equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m2596hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m2617toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m2729getDurationUwyO8pc() {
        return this.duration;
    }
