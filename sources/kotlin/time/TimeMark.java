...
public interface TimeMark {
    ...
    TimeMark mo2559minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2561plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2706plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2705minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2561plusLRDsOJo(Duration.m2621unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2601isNegativeimpl(timeMark.mo2558elapsedNowUwyO8pc());
        }
