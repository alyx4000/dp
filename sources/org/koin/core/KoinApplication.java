...
public final class KoinApplication {
    ...
    public final KoinApplication modules(List<Module> modules) {
        ...
        if (!this.koin.getLogger().isAt(Level.INFO)) {
            ...
            loadModules(modules);
            this.koin.getLogger().display(Level.INFO, "loaded " + this.koin.getInstanceRegistry().size() + " definitions in " + ((Number) new Pair(Unit.INSTANCE, Double.valueOf((KoinPlatformTimeTools.INSTANCE.getTimeInNanoSeconds() - timeInNanoSeconds) / 1000000.0d)).getSecond()).doubleValue() + " ms");
        }
        return this;
    }
