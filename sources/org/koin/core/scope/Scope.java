...
public final /* data */ class Scope {
    ...
    @Deprecated(message = "No need to use getSource(). You can an use get() directly.", replaceWith = @ReplaceWith(expression = FunSpec.GETTER, imports = {}))
    ...
    public final <T> T get(KClass<?> clazz, Qualifier qualifier, Function0<? extends ParametersHolder> parameters) {
        ...
        if (this._koin.getLogger().isAt(Level.DEBUG)) {
            ...
            this._koin.getLogger().display(Level.DEBUG, "|- '" + KClassExtKt.getFullName(clazz) + '\'' + str + " ...");
    ...
    private final <T> T resolveInstance(Qualifier qualifier, KClass<?> clazz, Function0<? extends ParametersHolder> parameterDef) {
        ...
        if (invoke != null) {
            ...
            KoinPlatformTools.INSTANCE.m3003synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$resolveInstance$2
        ...
        if (invoke != null) {
            ...
            KoinPlatformTools.INSTANCE.m3003synchronized(this, new Function0<ParametersHolder>() { // from class: org.koin.core.scope.Scope$resolveInstance$3
                {
                    super(0);
                }
        ...
        if (t == null) {
            ...
            if (t == null) {
                ...
                if (t == null) {
                    ...
                    if (t == null) {
                        KoinPlatformTools.INSTANCE.m3003synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$resolveValue$4$1
                            {
                                super(0);
                            }
    ...
    private final Void throwDefinitionNotFound(Qualifier qualifier, KClass<?> clazz) {
        ...
        throw new NoBeanDefFoundException("No definition found for class:'" + KClassExtKt.getFullName(clazz) + "' q:'" + str + "'. Check your definitions!");
    }
    ...
    public static /* synthetic */ void declare$default(Scope scope, Object obj, Qualifier qualifier, List list, boolean z, int i, Object obj2) {
        ...
        Intrinsics.needClassReification();
        koinPlatformTools.m3003synchronized(scope, new Scope$declare$1(scope, obj, qualifier2, secondaryTypes, z));
    }
    ...
    public final /* synthetic */ <T> void declare(T instance, Qualifier qualifier, List<? extends KClass<?>> secondaryTypes, boolean allowOverride) {
        ...
        KoinPlatformTools koinPlatformTools = KoinPlatformTools.INSTANCE;
        Intrinsics.needClassReification();
        koinPlatformTools.m3003synchronized(this, new Scope$declare$1(this, instance, qualifier, secondaryTypes, allowOverride));
    }
    ...
    public final void close() {
        KoinPlatformTools.INSTANCE.m3003synchronized(this, new Function0<Unit>() { // from class: org.koin.core.scope.Scope$close$1
            {
                super(0);
            }
