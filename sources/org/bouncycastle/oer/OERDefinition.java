...
public class OERDefinition {
    ...
    public static class Element {
        ...
        public String rangeExpression() {
            StringBuilder sb = new StringBuilder("(");
            BigInteger bigInteger = this.lowerBound;
            StringBuilder append = sb.append(bigInteger != null ? bigInteger.toString() : "MIN").append(" ... ");
            BigInteger bigInteger2 = this.upperBound;
            return append.append(bigInteger2 != null ? bigInteger2.toString() : "MAX").append(")").toString();
        }
    }
