...
public class I18nFormatUtil {
    ...
    private static class MessageFormatParser {
        ...
        private static final String[] TYPE_KEYWORDS = {"", ConditionData.NUMBER_VALUE, "date", "time", "choice"};
        private static final String[] NUMBER_MODIFIER_KEYWORDS = {"", "currency", ProfileMeasurement.UNIT_PERCENT, "integer"};
        private static final String[] DATE_TIME_MODIFIER_KEYWORDS = {"", "short", Constants.ScionAnalytics.PARAM_MEDIUM, "long", "full"};
