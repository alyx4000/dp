...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2749receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2749receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2750tryReceivePtdJZtk() {
        return this._channel.mo2750tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2745trySendJP2dKIU(E element) {
        return this._channel.mo2745trySendJP2dKIU(element);
    }
