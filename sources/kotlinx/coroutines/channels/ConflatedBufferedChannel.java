...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2773trySendImplMj0NB7M = conflatedBufferedChannel.m2773trySendImplMj0NB7M(e, true);
        if (m2773trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2759exceptionOrNullimpl(m2773trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2773trySendImplMj0NB7M = conflatedBufferedChannel.m2773trySendImplMj0NB7M(e, true);
        if (!(m2773trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2745trySendJP2dKIU(E element) {
        return m2773trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2773trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2771trySendDropLatestMj0NB7M(element, isSendOp) : m2772trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2771trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2745trySendJP2dKIU = super.mo2745trySendJP2dKIU(element);
        if (ChannelResult.m2765isSuccessimpl(mo2745trySendJP2dKIU) || ChannelResult.m2763isClosedimpl(mo2745trySendJP2dKIU)) {
            return mo2745trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m2770successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m2772trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2768closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2745trySendJP2dKIU = mo2745trySendJP2dKIU(element);
        if (!(mo2745trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2745trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2759exceptionOrNullimpl(mo2745trySendJP2dKIU);
