...
public interface SendChannel<E> {
    ...
    Object mo2745trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2745trySendJP2dKIU = sendChannel.mo2745trySendJP2dKIU(e);
            if (ChannelResult.m2765isSuccessimpl(mo2745trySendJP2dKIU)) {
                return true;
            }
            Throwable m2759exceptionOrNullimpl = ChannelResult.m2759exceptionOrNullimpl(mo2745trySendJP2dKIU);
