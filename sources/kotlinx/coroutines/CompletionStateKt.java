...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m1230exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m1230exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m1230exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m1230exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m1230exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m1227constructorimpl(ResultKt.createFailure(th));
        }
