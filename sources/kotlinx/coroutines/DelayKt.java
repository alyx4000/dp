...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2801scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2732delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2733toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2733toDelayMillisLRDsOJo(long j) {
        if (Duration.m2567compareToLRDsOJo(j, Duration.INSTANCE.m2671getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2586getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
