...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m1227constructorimpl = Result.m1227constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1233isFailureimpl(m1227constructorimpl) ? null : m1227constructorimpl);
