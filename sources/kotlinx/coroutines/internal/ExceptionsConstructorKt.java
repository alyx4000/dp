...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m1227constructorimpl = Result.m1227constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m1227constructorimpl = Result.m1227constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m1233isFailureimpl(m1227constructorimpl) ? null : m1227constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m1227constructorimpl = Result.m1227constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1227constructorimpl = Result.m1227constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m1233isFailureimpl(m1227constructorimpl)) {
            m1227constructorimpl = valueOf;
        }
        return ((Number) m1227constructorimpl).intValue();
    }
