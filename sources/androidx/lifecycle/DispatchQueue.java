...
public final class DispatchQueue {
    ...
    public final void dispatchAndEnqueue(CoroutineContext context, final Runnable runnable) {
        ...
        if (immediate.isDispatchNeeded(context) || canRun()) {
            immediate.mo2800dispatch(context, new Runnable() { // from class: androidx.lifecycle.DispatchQueue$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    DispatchQueue.m294dispatchAndEnqueue$lambda2$lambda1(DispatchQueue.this, runnable);
                }
            });
        } else {
            enqueue(runnable);
    ...
    public static final void m294dispatchAndEnqueue$lambda2$lambda1(DispatchQueue this$0, Runnable runnable) {
