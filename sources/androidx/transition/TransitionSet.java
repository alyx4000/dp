...
public class TransitionSet extends Transition {
    ...
    String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            transition = transition + "\n" + this.mTransitions.get(i).toString(str + FileSpecKt.DEFAULT_INDENT);
        }
        return transition;
    }
    ...
    @Override // androidx.transition.Transition
    /* renamed from: clone */
    public Transition mo342clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo342clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo342clone());
        }
