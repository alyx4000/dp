...
public final class PublicKeyCredentialControllerUtility {
    ...
    private static final String JSON_KEY_TIMEOUT = ProfilingTraceData.TRUNCATION_REASON_TIMEOUT;
    ...
    public static final class Companion {
        ...
        public final void parseOptionalWithRequiredDefaultsAttestationAndExcludeCredentials$credentials_play_services_auth_release(JSONObject json, PublicKeyCredentialCreationOptions.Builder builder) {
            ...
            builder.setAttestationConveyancePreference(AttestationConveyancePreference.fromString(attestationString.length() == 0 ? "none" : attestationString));
        }
