...
public final class PublicKeyCredentialCreationOptions {
    ...
    public PublicKeyCredentialCreationOptions(String requestJson) {
        ...
        this.timeout = this.json.optLong(ProfilingTraceData.TRUNCATION_REASON_TIMEOUT, 0L);
