...
public class ContentLoadingProgressBar extends ProgressBar {
    ...
    /* synthetic */ void m249lambda$new$0$androidxcorewidgetContentLoadingProgressBar() {
    ...
    /* synthetic */ void m250lambda$new$1$androidxcorewidgetContentLoadingProgressBar() {
    ...
    public ContentLoadingProgressBar(Context context, AttributeSet attributeSet) {
        ...
        this.mDelayedHide = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda2
            ...
            public final void run() {
                ContentLoadingProgressBar.this.m249lambda$new$0$androidxcorewidgetContentLoadingProgressBar();
            }
        };
        this.mDelayedShow = new Runnable() { // from class: androidx.core.widget.ContentLoadingProgressBar$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                ContentLoadingProgressBar.this.m250lambda$new$1$androidxcorewidgetContentLoadingProgressBar();
            }
        };
    }
