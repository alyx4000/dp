...
public abstract class AbstractAppBarOnDestinationChangedListener implements NavController.OnDestinationChangedListener {
    ...
    public void onDestinationChanged(NavController controller, NavDestination destination, Bundle arguments) {
        ...
        if (label != null) {
            ...
            while (matcher.find()) {
                ...
                if (arguments != null && arguments.containsKey(group)) {
                    ...
                    throw new IllegalArgumentException("Could not find \"" + group + "\" in " + arguments + " to fill label \"" + ((Object) label) + Typography.quote);
                }
            }
        ...
        if (openable == null && matchDestinations$navigation_ui_release) {
            ...
            setActionBarUpIndicator(openable != null && matchDestinations$navigation_ui_release);
        }
    }
