...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mTextureView.getContext()), new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda4
            ...
            public final void run() {
                TextureViewImplementation.this.m216xce057d29(surfaceRequest);
            }
        });
    ...
    /* synthetic */ void m216xce057d29(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    void tryToProvidePreviewSurface() {
        ...
        final ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return TextureViewImplementation.this.m217xdd0bd278(surface, completer);
            }
        });
        ...
        future.addListener(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                TextureViewImplementation.this.m218x16d67457(surface, future, surfaceRequest);
            }
    ...
    /* synthetic */ Object m217xdd0bd278(Surface surface, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    /* synthetic */ void m218x16d67457(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
    ...
    ListenableFuture<Void> waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda2
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return TextureViewImplementation.this.m219x86b0fc00(completer);
            }
        });
    }

    /* renamed from: lambda$waitForNextFrame$3$androidx-camera-view-TextureViewImplementation, reason: not valid java name */
    /* synthetic */ Object m219x86b0fc00(CallbackToFutureAdapter.Completer completer) throws Exception {
