...
final class ImageSaver implements Runnable {
        ...
        if (saveImageToTempFile != null) {
            this.mSequentialIoExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ImageSaver.this.m144lambda$run$0$androidxcameracoreImageSaver(saveImageToTempFile);
                }
            });
        }
    }
    ...
    */
    public void m144lambda$run$0$androidxcameracoreImageSaver(java.io.File r6) {
        /*
            r5 = this;
        ...
        La8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.ImageSaver.m144lambda$run$0$androidxcameracoreImageSaver(java.io.File):void");
    }
    ...
    private void postSuccess(final Uri uri) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ImageSaver.this.m143lambda$postSuccess$1$androidxcameracoreImageSaver(uri);
                }
            });
    ...
    /* synthetic */ void m143lambda$postSuccess$1$androidxcameracoreImageSaver(Uri uri) {
    ...
    private void postError(final SaveError saveError, final String str, final Throwable th) {
        try {
            this.mUserCallbackExecutor.execute(new Runnable() { // from class: androidx.camera.core.ImageSaver$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ImageSaver.this.m142lambda$postError$2$androidxcameracoreImageSaver(saveError, str, th);
                }
            });
        } catch (RejectedExecutionException unused) {
    ...
    /* synthetic */ void m142lambda$postError$2$androidxcameracoreImageSaver(SaveError saveError, String str, Throwable th) {
