...
class AndroidImageReaderProxy implements ImageReaderProxy {
        ...
        synchronized (this.mLock) {
            ...
            this.mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda1
                ...
                public final void onImageAvailable(ImageReader imageReader) {
                    AndroidImageReaderProxy.this.m121x2fd48a6(executor, onImageAvailableListener, imageReader);
                }
    ...
    /* synthetic */ void m121x2fd48a6(Executor executor, final ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        synchronized (this.mLock) {
            if (!this.mIsImageAvailableListenerCleared) {
                executor.execute(new Runnable() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        AndroidImageReaderProxy.this.m120x4985bb07(onImageAvailableListener);
                    }
                });
            }
        }
    ...
    /* synthetic */ void m120x4985bb07(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
