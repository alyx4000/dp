...
public class SurfaceSorter {
        ...
        if (this.mHasQuirk) {
            Collections.sort(list, new Comparator() { // from class: androidx.camera.core.internal.compat.workaround.SurfaceSorter$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return SurfaceSorter.this.m184xa3d7ce91((SessionConfig.OutputConfig) obj, (SessionConfig.OutputConfig) obj2);
                }
            });
        }
    }
    ...
    /* synthetic */ int m184xa3d7ce91(SessionConfig.OutputConfig outputConfig, SessionConfig.OutputConfig outputConfig2) {
