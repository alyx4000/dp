...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return DeferrableSurface.this.m176lambda$new$0$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        ...
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    DeferrableSurface.this.m177lambda$new$1$androidxcameracoreimplDeferrableSurface(stackTraceString);
                }
    ...
    /* synthetic */ Object m176lambda$new$0$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    /* synthetic */ void m177lambda$new$1$androidxcameracoreimplDeferrableSurface(String str) {
        try {
