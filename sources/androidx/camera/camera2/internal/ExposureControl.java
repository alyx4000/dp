...
public class ExposureControl {
    ...
    ListenableFuture<Integer> setExposureCompensationIndex(final int i) {
        ...
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return ExposureControl.this.m57x8eaf9914(i, completer);
            }
        }));
    }
    ...
    /* synthetic */ Object m57x8eaf9914(final int i, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ExposureControl.this.m56x9d05f2f5(completer, i);
            }
        });
    ...
    /* synthetic */ void m56x9d05f2f5(final CallbackToFutureAdapter.Completer completer, final int i) {
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
