...
class Camera2CapturePipeline {
    ...
    static class Pipeline {
        ...
        ListenableFuture<List<Void>> executeCapture(final List<CaptureConfig> list, final int i) {
            ...
            if (!this.mTasks.isEmpty()) {
                immediateFuture = FutureChain.from(this.mPipelineSubTask.isCaptureResultNeeded() ? Camera2CapturePipeline.waitForResult(0L, this.mCameraControl, null) : Futures.immediateFuture(null)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda2
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return Camera2CapturePipeline.Pipeline.this.m46xe4aaa129(i, (TotalCaptureResult) obj);
                    }
                    ...
                    @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                    public final ListenableFuture apply(Object obj) {
                        return Camera2CapturePipeline.Pipeline.this.m47xb909b167((Boolean) obj);
                    }
                }, this.mExecutor);
            }
            FutureChain transformAsync = FutureChain.from(immediateFuture).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda4
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m48x23393986(list, i, (TotalCaptureResult) obj);
                }
            }, this.mExecutor);
        ...
        /* synthetic */ ListenableFuture m46xe4aaa129(int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        /* synthetic */ ListenableFuture m47xb909b167(Boolean bool) throws Exception {
            if (Boolean.TRUE.equals(bool)) {
                return Camera2CapturePipeline.waitForResult(this.mTimeout3A, this.mCameraControl, new ResultListener.Checker() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda1
        ...
        /* synthetic */ ListenableFuture m48x23393986(List list, int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        */
        com.google.common.util.concurrent.ListenableFuture<java.util.List<java.lang.Void>> submitConfigsInternal(java.util.List<androidx.camera.core.impl.CaptureConfig> r7, int r8) {
            /*
                r6 = this;
        ...
        /* synthetic */ Object m49x1f41775a(CaptureConfig.Builder builder, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    static class TorchTask implements PipelineTask {
                ...
                if (this.mCameraControl.isTorchOn()) {
                    ...
                    return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda1
                        ...
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return Camera2CapturePipeline.TorchTask.this.m51x3ebf0c8c(completer);
                        }
                        ...
                        @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                        public final ListenableFuture apply(Object obj) {
                            return Camera2CapturePipeline.TorchTask.this.m52xf642040e((Void) obj);
                        }
        ...
        /* synthetic */ Object m51x3ebf0c8c(CallbackToFutureAdapter.Completer completer) throws Exception {
            this.mCameraControl.getTorchControl().m82xbd10d892(completer, true);
            return "TorchOn";
        }
        ...
        /* synthetic */ ListenableFuture m52xf642040e(Void r4) throws Exception {
            return Camera2CapturePipeline.waitForResult(CHECK_3A_WITH_TORCH_TIMEOUT_IN_NS, this.mCameraControl, new ResultListener.Checker() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda0
                @Override // androidx.camera.camera2.internal.Camera2CapturePipeline.ResultListener.Checker
                public final boolean check(TotalCaptureResult totalCaptureResult) {
                    boolean is3AConverged;
        ...
        public void postCapture() {
            if (this.mIsExecuted) {
                this.mCameraControl.getTorchControl().m82xbd10d892(null, false);
    ...
    static class AePreCaptureTask implements PipelineTask {
        ...
        public ListenableFuture<Boolean> preCapture(TotalCaptureResult totalCaptureResult) {
            if (Camera2CapturePipeline.isFlashRequired(this.mFlashMode, totalCaptureResult)) {
                ...
                return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$AePreCaptureTask$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CapturePipeline.AePreCaptureTask.this.m45x78c3ed41(completer);
                    }
        ...
        /* synthetic */ Object m45x78c3ed41(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    static class ResultListener implements Camera2CameraControlImpl.CaptureResultListener {
        ...
        private final ListenableFuture<TotalCaptureResult> mFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ResultListener$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CapturePipeline.ResultListener.this.m50xaa6bbe23(completer);
            }
        });
        ...
        /* synthetic */ Object m50xaa6bbe23(CallbackToFutureAdapter.Completer completer) throws Exception {
