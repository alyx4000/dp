...
final class CaptureSession implements CaptureSessionInterface {
    ...
    /* JADX WARN: Removed duplicated region for block: B:22:0x0058 A[Catch: all -> 0x00a9, TryCatch #1 {, blocks: (B:4:0x0009, B:5:0x0013, B:7:0x00a2, B:11:0x0018, B:16:0x001e, B:14:0x002a, B:19:0x0023, B:20:0x002f, B:22:0x0058, B:23:0x005c, B:25:0x0060, B:26:0x006b, B:27:0x006d, B:29:0x006f, B:30:0x0088, B:31:0x008d, B:32:0x00a1), top: B:3:0x0009, inners: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:25:0x0060 A[Catch: all -> 0x00a9, TryCatch #1 {, blocks: (B:4:0x0009, B:5:0x0013, B:7:0x00a2, B:11:0x0018, B:16:0x001e, B:14:0x002a, B:19:0x0023, B:20:0x002f, B:22:0x0058, B:23:0x005c, B:25:0x0060, B:26:0x006b, B:27:0x006d, B:29:0x006f, B:30:0x0088, B:31:0x008d, B:32:0x00a1), top: B:3:0x0009, inners: #0 }] */
    @Override // androidx.camera.camera2.internal.CaptureSessionInterface
    /*
    ...
    */
    public com.google.common.util.concurrent.ListenableFuture<java.lang.Void> release(boolean r7) {
        /*
            ...
            monitor-enter(r3)
            int[] r4 = androidx.camera.camera2.internal.CaptureSession.AnonymousClass4.$SwitchMap$androidx$camera$camera2$internal$CaptureSession$State     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.internal.CaptureSession$State r5 = r6.mState     // Catch: java.lang.Throwable -> La9
            int r5 = r5.ordinal()     // Catch: java.lang.Throwable -> La9
        ...
        L16:
            goto La2
        L18:
            androidx.camera.camera2.internal.SynchronizedCaptureSession r1 = r6.mSynchronizedCaptureSession     // Catch: java.lang.Throwable -> La9
            if (r1 == 0) goto L2f
            if (r7 == 0) goto L2a
            r1.abortCaptures()     // Catch: android.hardware.camera2.CameraAccessException -> L22 java.lang.Throwable -> La9
            goto L2a
        L22:
            r7 = move-exception
            java.lang.String r1 = "CaptureSession"
            java.lang.String r2 = "Unable to abort captures."
            androidx.camera.core.Logger.e(r1, r2, r7)     // Catch: java.lang.Throwable -> La9
        L2a:
            androidx.camera.camera2.internal.SynchronizedCaptureSession r7 = r6.mSynchronizedCaptureSession     // Catch: java.lang.Throwable -> La9
            r7.close()     // Catch: java.lang.Throwable -> La9
        L2f:
            androidx.camera.camera2.impl.CameraEventCallbacks r7 = r6.mCameraEventCallbacks     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.impl.CameraEventCallbacks$ComboCameraEventCallback r7 = r7.createComboCallback()     // Catch: java.lang.Throwable -> La9
            r7.onDeInitSession()     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.internal.CaptureSession$State r7 = androidx.camera.camera2.internal.CaptureSession.State.RELEASING     // Catch: java.lang.Throwable -> La9
            r6.mState = r7     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.internal.SynchronizedCaptureSessionOpener r7 = r6.mSynchronizedCaptureSessionOpener     // Catch: java.lang.Throwable -> La9
            ...
            androidx.camera.camera2.internal.CaptureSession$State r0 = r6.mState     // Catch: java.lang.Throwable -> La9
            java.lang.StringBuilder r0 = r1.append(r0)     // Catch: java.lang.Throwable -> La9
            java.lang.String r0 = r0.toString()     // Catch: java.lang.Throwable -> La9
            androidx.core.util.Preconditions.checkNotNull(r7, r0)     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.internal.SynchronizedCaptureSessionOpener r7 = r6.mSynchronizedCaptureSessionOpener     // Catch: java.lang.Throwable -> La9
            boolean r7 = r7.stop()     // Catch: java.lang.Throwable -> La9
            if (r7 == 0) goto L5c
            r6.finishClose()     // Catch: java.lang.Throwable -> La9
            goto La2
        L5c:
            com.google.common.util.concurrent.ListenableFuture<java.lang.Void> r7 = r6.mReleaseFuture     // Catch: java.lang.Throwable -> La9
            if (r7 != 0) goto L6b
            androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda2 r7 = new androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda2     // Catch: java.lang.Throwable -> La9
            r7.<init>()     // Catch: java.lang.Throwable -> La9
            com.google.common.util.concurrent.ListenableFuture r7 = androidx.concurrent.futures.CallbackToFutureAdapter.getFuture(r7)     // Catch: java.lang.Throwable -> La9
            r6.mReleaseFuture = r7     // Catch: java.lang.Throwable -> La9
        L6b:
            com.google.common.util.concurrent.ListenableFuture<java.lang.Void> r7 = r6.mReleaseFuture     // Catch: java.lang.Throwable -> La9
        ...
        L6f:
            ...
            androidx.camera.camera2.internal.CaptureSession$State r1 = r6.mState     // Catch: java.lang.Throwable -> La9
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch: java.lang.Throwable -> La9
            java.lang.String r0 = r0.toString()     // Catch: java.lang.Throwable -> La9
            androidx.core.util.Preconditions.checkNotNull(r7, r0)     // Catch: java.lang.Throwable -> La9
            androidx.camera.camera2.internal.SynchronizedCaptureSessionOpener r7 = r6.mSynchronizedCaptureSessionOpener     // Catch: java.lang.Throwable -> La9
            r7.stop()     // Catch: java.lang.Throwable -> La9
        L88:
            androidx.camera.camera2.internal.CaptureSession$State r7 = androidx.camera.camera2.internal.CaptureSession.State.RELEASED     // Catch: java.lang.Throwable -> La9
            r6.mState = r7     // Catch: java.lang.Throwable -> La9
            goto La2
        L8d:
                ...
                if (this.mStillCaptureFlow.shouldStopRepeatingBeforeCapture(arrayList, z)) {
                    ...
                    cameraBurstCaptureCallback.setCaptureSequenceCallback(new CameraBurstCaptureCallback.CaptureSequenceCallback() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda0
                        ...
                        public final void onCaptureSequenceCompletedOrAborted(CameraCaptureSession cameraCaptureSession, int i, boolean z3) {
                            CaptureSession.this.m53xaccd0633(cameraCaptureSession, i, z3);
                        }
                    });
                }
    ...
    /* synthetic */ void m53xaccd0633(CameraCaptureSession cameraCaptureSession, int i, boolean z) {
        synchronized (this.mSessionLock) {
