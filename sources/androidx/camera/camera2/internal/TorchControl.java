...
final class TorchControl {
    ...
    TorchControl(Camera2CameraControlImpl camera2CameraControlImpl, CameraCharacteristicsCompat cameraCharacteristicsCompat, Executor executor) {
        ...
        camera2CameraControlImpl.addCaptureResultListener(new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda2
            ...
            public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
                return TorchControl.this.m84lambda$new$0$androidxcameracamera2internalTorchControl(totalCaptureResult);
            }
        });
    }

    /* renamed from: lambda$new$0$androidx-camera-camera2-internal-TorchControl, reason: not valid java name */
    /* synthetic */ boolean m84lambda$new$0$androidxcameracamera2internalTorchControl(TotalCaptureResult totalCaptureResult) {
    ...
    ListenableFuture<Void> enableTorch(final boolean z) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda1
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return TorchControl.this.m83x328afed3(z, completer);
            }
        });
    }

    /* renamed from: lambda$enableTorch$2$androidx-camera-camera2-internal-TorchControl, reason: not valid java name */
    /* synthetic */ Object m83x328afed3(final boolean z, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.TorchControl$$ExternalSyntheticLambda0
            ...
            public final void run() {
                TorchControl.this.m82xbd10d892(completer, z);
            }
        });
    ...
    public void m82xbd10d892(CallbackToFutureAdapter.Completer<Void> completer, boolean z) {
        if (!this.mHasFlashUnit) {
            if (completer != null) {
