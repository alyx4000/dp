...
public class BiometricFragment extends Fragment {
        ...
        if (viewModel != null) {
            ...
            viewModel.getAuthenticationResult().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda2
                ...
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m10lambda$connectViewModel$0$androidxbiometricBiometricFragment(viewModel, (BiometricPrompt.AuthenticationResult) obj);
                }
            });
            viewModel.getAuthenticationError().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda3
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m11lambda$connectViewModel$1$androidxbiometricBiometricFragment(viewModel, (BiometricErrorData) obj);
                }
            });
            viewModel.getAuthenticationHelpMessage().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda4
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m12lambda$connectViewModel$2$androidxbiometricBiometricFragment(viewModel, (CharSequence) obj);
                }
            });
            viewModel.isAuthenticationFailurePending().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda5
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m13lambda$connectViewModel$3$androidxbiometricBiometricFragment(viewModel, (Boolean) obj);
                }
            });
            viewModel.isNegativeButtonPressPending().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda6
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m14lambda$connectViewModel$4$androidxbiometricBiometricFragment(viewModel, (Boolean) obj);
                }
            });
            viewModel.isFingerprintDialogCancelPending().observe(this, new Observer() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda7
                @Override // androidx.lifecycle.Observer
                public final void onChanged(Object obj) {
                    BiometricFragment.this.m15lambda$connectViewModel$5$androidxbiometricBiometricFragment(viewModel, (Boolean) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ void m10lambda$connectViewModel$0$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, BiometricPrompt.AuthenticationResult authenticationResult) {
    ...
    /* synthetic */ void m11lambda$connectViewModel$1$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, BiometricErrorData biometricErrorData) {
    ...
    /* synthetic */ void m12lambda$connectViewModel$2$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, CharSequence charSequence) {
    ...
    /* synthetic */ void m13lambda$connectViewModel$3$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, Boolean bool) {
    ...
    /* synthetic */ void m14lambda$connectViewModel$4$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, Boolean bool) {
        if (bool.booleanValue()) {
    ...
    /* synthetic */ void m15lambda$connectViewModel$5$androidxbiometricBiometricFragment(BiometricViewModel biometricViewModel, Boolean bool) {
        if (bool.booleanValue()) {
    ...
    private void showFingerprintDialogForAuthentication() {
        ...
        if (checkForFingerprintPreAuthenticationErrors != 0) {
            m16x21f86f4c(checkForFingerprintPreAuthenticationErrors, ErrorUtils.getFingerprintErrorString(applicationContext, checkForFingerprintPreAuthenticationErrors));
            return;
        }
        final BiometricViewModel viewModel = getViewModel();
    ...
    void authenticateWithFingerprint(FingerprintManagerCompat fingerprintManagerCompat, Context context) {
        ...
        try {
            ...
            m16x21f86f4c(1, ErrorUtils.getFingerprintErrorString(context, 1));
        }
    }
    ...
    void authenticateWithBiometricPrompt(android.hardware.biometrics.BiometricPrompt biometricPrompt, Context context) {
        ...
        try {
            ...
            m16x21f86f4c(1, context != null ? context.getString(R.string.default_error_msg) : "");
        }
    }
    ...
    void onAuthenticationError(final int i, final CharSequence charSequence) {
        ...
        if (viewModel.isFingerprintDialogDismissedInstantly()) {
            ...
            this.mInjector.getHandler().postDelayed(new Runnable() { // from class: androidx.biometric.BiometricFragment$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BiometricFragment.this.m16x21f86f4c(i, charSequence);
                }
    ...
    void onCancelButtonPressed() {
        ...
        m16x21f86f4c(13, negativeButtonText);
    ...
    private void launchConfirmCredentialActivity() {
        ...
        if (keyguardManager == null) {
            m16x21f86f4c(12, getString(R.string.generic_error_no_keyguard));
            return;
        }
        CharSequence title = viewModel.getTitle();
        CharSequence subtitle = viewModel.getSubtitle();
        ...
        if (createConfirmDeviceCredentialIntent == null) {
            m16x21f86f4c(14, getString(R.string.generic_error_no_device_credential));
            return;
        }
    ...
    private void handleConfirmCredentialResult(int i) {
        ...
        m16x21f86f4c(10, getString(R.string.generic_error_user_canceled));
    }
    ...
    public void m16x21f86f4c(int i, CharSequence charSequence) {
        sendErrorToClient(i, charSequence);
        dismiss();
    }
