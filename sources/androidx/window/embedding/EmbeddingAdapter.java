...
public final class EmbeddingAdapter {
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda4
            ...
            public final boolean test(Object obj) {
                boolean m347translateActivityPairPredicates$lambda1;
                m347translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m347translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m347translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public static final boolean m347translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m346translateActivityIntentPredicates$lambda3;
                m346translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m346translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m346translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public static final boolean m346translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(splitPairFilters, "$splitPairFilters");
        Intrinsics.checkNotNullExpressionValue(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda2
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m350translateParentMetricsPredicate$lambda4;
                m350translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m350translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m350translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    public static final boolean m350translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        Intrinsics.checkNotNullParameter(splitRule, "$splitRule");
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda1
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m348translateActivityPredicates$lambda6;
                m348translateActivityPredicates$lambda6 = EmbeddingAdapter.m348translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m348translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public static final boolean m348translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.EmbeddingAdapter$$ExternalSyntheticLambda3
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m349translateIntentPredicates$lambda8;
                m349translateIntentPredicates$lambda8 = EmbeddingAdapter.m349translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m349translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public static final boolean m349translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        Intrinsics.checkNotNullParameter(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
