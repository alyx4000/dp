...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        public final void accept(Object obj) {
            FragmentManager.this.m282lambda$new$0$androidxfragmentappFragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda1
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m283lambda$new$1$androidxfragmentappFragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda2
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m284lambda$new$2$androidxfragmentappFragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda3
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            FragmentManager.this.m285lambda$new$3$androidxfragmentappFragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    /* synthetic */ void m282lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m283lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    /* synthetic */ void m284lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m285lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    Parcelable saveAllState() {
        ...
        Bundle m281lambda$attachController$4$androidxfragmentappFragmentManager = m281lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m281lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
            return null;
        }
        return m281lambda$attachController$4$androidxfragmentappFragmentManager;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: saveAllStateInternal, reason: merged with bridge method [inline-methods] */
    public Bundle m281lambda$attachController$4$androidxfragmentappFragmentManager() {
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            for (int i = 0; i < fragmentManagerState.mBackStack.length; i++) {
                ...
                if (isLoggingEnabled(2)) {
                    ...
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
                    instantiate.dump(FileSpecKt.DEFAULT_INDENT, printWriter, false);
                    printWriter.close();
                }
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda4
                ...
                public final Bundle saveState() {
                    return FragmentManager.this.m281lambda$attachController$4$androidxfragmentappFragmentManager();
                }
            });
