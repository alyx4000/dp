...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(str + FileSpecKt.DEFAULT_INDENT, fileDescriptor, printWriter, strArr);
    }
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m281lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m281lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m281lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m281lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
